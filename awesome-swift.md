...
- [OpenAI](https://github.com/MacPaw/OpenAI) - Swift package for OpenAI public API. [back to top](#readme)
...
- [voice-overlay-ios](https://github.com/algolia/voice-overlay-ios) - An overlay that gets your user’s voice permission and input as text in a customizable UI. [back to top](#readme)
...
- [Telegrammer](https://github.com/givip/Telegrammer) - [back to top](#readme)
...
- [MemoryCache](https://github.com/yysskk/MemoryCache) - Type-safe memory cache. [back to top](#readme)
...
- [SwiftGen-Colors](https://github.com/SwiftGen/SwiftGen) - A tool to auto-generate `enums` for your `UIColor` constants.
...
- [Venice](https://github.com/Zewo/Venice) - [back to top](#readme) [back to top](#readme)
...
- [CSVParser](https://github.com/Nero5023/CSVParser) - [back to top](#readme)
- [Ballcap](https://github.com/1amageek/Ballcap-iOS) - Ballcap is a database schema design framework for Cloud Firestore. [back to top](#readme)
...
- [Sextant](https://github.com/KittyMac/Sextant)
- [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) - A lib for JSON with error handling.
- [SwiftyJSONAccelerator](https://github.com/insanoid/SwiftyJSONAccelerator) - macOS app to generate Swift 5 models for JSON (with Codeable). [back to top](#readme)
...
- [Zephyr](https://github.com/ArtSabintsev/Zephyr) - Effortlessly synchronize NSUserDefaults over iCloud. [back to top](#readme)
...
- [Shallows](https://github.com/dreymonde/Shallows) - Your lightweight persistence toolbox. [back to top](#readme)
...
- [StorageManager](https://github.com/iAmrSalman/StorageManager) - Safe and easy way to use FileManager as Database. [back to top](#readme)
...
- [Unrealm](https://github.com/matghazaryan/Unrealm) - Unrealm enables you to easily store Swift native Classes, Structs and Enums into Realm. [back to top](#readme)
...
- [XMLMapper](https://github.com/gcharita/XMLMapper) - A simple way to map XML to Objects. [back to top](#readme)
- [YamlSwift](https://github.com/behrang/YamlSwift) - Load YAML and JSON documents.
- [Yams](https://github.com/jpsim/Yams) - [back to top](#readme)
...
- [SourceDocs](https://github.com/SourceDocs/SourceDocs) - Generate Markdown reference documentation that lives with your code. [back to top](#readme)
...
- [When](https://github.com/vadymmarkov/When) - A lightweight implementation of Promises. [back to top](#readme)
...
- [UIFontComplete](https://github.com/Nirma/UIFontComplete) - Font management (System & Custom) for iOS and tvOS. [back to top](#readme)
...
- [ImagineEngine](https://github.com/JohnSundell/ImagineEngine) - Blazing fasst 2D gaming engine. [back to top](#readme)
- [FDChessboardView](https://github.com/fulldecent/FDChessboardView) - A view controller for chess boards
- [Sage](https://github.com/nvzqz/Sage) - [back to top](#readme)
...
- [SwiftGen-Assets](https://github.com/SwiftGen/SwiftGen) - A tool to auto-generate `enums` for all your `UIImages` from your Assets Catalogs.
...
- [SwiftGen-L10n](https://github.com/SwiftGen/SwiftGen) - A tool to auto-generate `enums` for all your Localizable.strings keys (with appropriate associated values if those strings contains printf-format placeholders like `%@`).
- [Translatio](https://github.com/andrealufino/Translatio) - Super lightweight library that helps you to localize strings, even directly in storyboards. [back to top](#readme)
...
- [XCGLogger](https://github.com/DaveWoodCom/XCGLogger) - Full featured & Configurable logging utility with log levels, timestamps, and line numbers. [back to top](#readme)
...
- [LocoKit](https://github.com/sobri909/LocoKit) - A location and activity recording framework for iOS. [back to top](#readme)
...
- [Upsurge](https://github.com/alejandro-isaza/Upsurge) - Simple and fast matrix and vector math. [back to top](#readme)
...
- [ZMarkupParser](https://github.com/ZhgChgLi/ZMarkupParser) - Helps you convert HTML strings into NSAttributedString with customized styles and tags. [back to top](#readme)
- [CocoaMQTT](https://github.com/emqx/CocoaMQTT) - MQTT for iOS and OS X.
- [Perfect-Notifications](https://github.com/PerfectlySoft/Perfect-Notifications) - iOS Notifications for Linux and OS X. [back to top](#readme)
- [SOAPEngine](https://github.com/priore/SOAPEngine) - Generic SOAP client to access SOAP Web Services using iOS, Mac OS X, and Apple TV. [back to top](#readme)
...
- [Zewo](https://github.com/Zewo/Zewo) - [back to top](#readme)
- [SwiftOCR](https://github.com/NMAC427/SwiftOCR) - Neural Network based OCR lib. [back to top](#readme) [back to top](#readme)
...
- [UXMPDFKit](https://github.com/uxmstudio/UXMPDFKit) - A PDF viewer and annotator that can be embedded in iOS applications. [back to top](#readme)
- [AnyLint](https://github.com/FlineDev/AnyLint)
...
- [Tailor](https://github.com/sleekbyte/tailor) - [back to top](#readme)
- [Swift for Scripting](https://github.com/artemnovichkov/Swift-For-Scripting) - A hand-curated collection of useful and informative scripting material. [back to top](#readme) [back to top](#readme)
...
- [Themis](https://github.com/cossacklabs/themis) - Multilanguage framework for making typical encryption schemes easy to use: data at rest, authenticated data exchange, transport protection, authentication, and so on. [back to top](#readme)
...
- [Valet](https://github.com/square/Valet) - Valet lets you securely store data in the Keychain without knowing a thing about how the Keychain works. It’s easy. We promise. [back to top](#readme)
...
- [Live](https://github.com/ltebean/Live) - Demonstrate how to build a live broadcast app. [back to top](#readme)
...
- [Themes](https://github.com/onmyway133/EasyTheme) - Theme management. [back to top](#readme)
- [SVGView](https://github.com/exyte/SVGView) - SVG parser and renderer written in SwiftUI. [back to top](#readme)
...
- [XCTest](https://github.com/swiftlang/swift-corelibs-xctest) - The XCTest Project, A Swift core library for providing unit test support. [back to top](#readme)
...
- [Zingle](https://github.com/hemangshah/Zingle) - An alert will display underneath your UINavigationBar. [back to top](#readme)
- [VisualEffectView](https://github.com/efremidze/VisualEffectView) - UIVisualEffectView subclass with tint color. [back to top](#readme)
...
- [TransitionButton](https://github.com/AladinWay/TransitionButton) - UIButton subclass for loading and transition animation. [back to top](#readme)
...
- [Workaholic](https://github.com/hemangshah/Workaholic) - A GitHub-like work contribution timeline. [back to top](#readme)
...
- [VerticalCardSwiper](https://github.com/JoniVR/VerticalCardSwiper) - A marriage between the Shazam Discover UI and Tinder, built with UICollectionView. [back to top](#readme)
...
- [SwiftyFORM](https://github.com/neoneye/SwiftyFORM) - Forms that can be validated. [back to top](#readme)
...
- [PKHUD](https://github.com/pkluz/PKHUD) - Reimplementation of the Apple HUD. [back to top](#readme)
...
- [TriLabelView](https://github.com/mukeshthawani/TriLabelView) - A triangle shaped corner label view for iOS. [back to top](#readme)
...
- [YNDropDownMenu](https://github.com/younatics/YNDropDownMenu) - Adorable iOS drop down menu. [back to top](#readme)
...
- [SlideController](https://github.com/touchlane/SlideController) - It is a nice alternative for UIPageViewController built using power of generic types. Swipe between pages with an interactive title navigation control. Configure horizontal or vertical chains for unlimited pages amount. [back to top](#readme)
...
- [TPInAppReceipt](https://github.com/tikhop/TPInAppReceipt) - A lightweight, pure-Swift library for reading and validating Apple In App Purchase Receipt locally. [back to top](#readme)
...
- [SPPermission](https://github.com/sparrowcode/PermissionsKit) - Simple request permission with native UI and interactive animation. [back to top](#readme)
- [DMScrollBar](https://github.com/batanus/DMScrollBar) - Best in class customizable ScrollBar for any type of ScrollView with Decelerating, Bounce & Rubber band mechanisms and many many more. [back to top](#readme)
- [StackViewController](https://github.com/seedco/StackViewController) - Simplify the use of UIStackView.
- [TZStackView](https://github.com/tomvanzummeren/TZStackView) - An iOS9 UIStackView layout component re-implemented for iOS 7 and 8. [back to top](#readme)
...
- [Switch](https://github.com/T-Pham/Switch) - A switch control with full Interface Builder support. [back to top](#readme)
...
- [TabPageViewController](https://github.com/EndouMari/TabPageViewController) - Paging view controller and scroll tab view. [back to top](#readme)
...
- [Temple](https://github.com/GoodRequest/Temple) - 🗂️ Most advanced project and file templates. [back to top](#readme)
...
- [VKPinCodeView](https://github.com/Sunspension/VKPinCodeView) - Simple and elegant UI component for input PIN. [back to top](#readme)
...
- [Transition](https://github.com/Touchwonders/Transition) - Easy interactive interruptible custom ViewController transitions. [back to top](#readme)
- [Insert3D](https://github.com/Viktoo/Insert3D) - The fastest 🚀 way to embed a 3D model. [back to top](#readme)
...
- [VegaScroll](https://github.com/AppliKeySolutions/VegaScroll) - Lightweight animation flowlayout for UICollectionView. [back to top](#readme)
...
- [YNExpandableCell](https://github.com/younatics/YNExpandableCell) - Awesome expandable, collapsible tableview cell for iOS. [back to top](#readme)
...
- [SwiftGen-Storyboard](https://github.com/SwiftGen/SwiftGen) - A tool to auto-generate `enums` for all your Storyboards, Scenes and Segues constants + appropriate convenience accessors.
...
- [PhoneNumberKit](https://github.com/marmelroy/PhoneNumberKit) - Framework for parsing, formatting and validating international phone numbers. Inspired by Google's libphonenumber. [back to top](#readme)
...
- [Version Tracker Swift](https://github.com/tbaranes/VersionTrackerSwift) - Versions tracker for your iOS, OS X, and tvOS app. [back to top](#readme)
...
- [Raywenderlich](https://github.com/kodecocodes/swift-style-guide) - Raywenderlich guide, a must read. [back to top](#readme)
...
- [swift-mode](https://github.com/swift-emacs/swift-mode) - Emacs support, including partial flycheck error support. [back to top](#readme)
- [swift-colab](https://github.com/philipturner/swift-colab) - Run Swift in a browser. [back to top](#readme)
