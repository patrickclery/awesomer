...
| [jamm](https://github.com/jbellis/jamm) | Measure actual object memory use including JVM overhead. | 693 | 2024-01-18 |
...
| [jvm-profiler](https://github.com/uber-common/jvm-profiler) | Java Agent to collect various metrics and stacktraces for Hadoop/Spark JVM processes in a distrib... | 1796 | 2025-07-12 |
...
| [Riemann JVM Profiler](https://github.com/riemann/riemann-jvm-profiler) | JVM agent which sends function-level profiler telemetry to a Riemann server for analysis, visuali... | 295 | 2024-09-03 |
...
| [Agrona](https://github.com/real-logic/Agrona) | Library of data structures and utility methods that are a common need when building high-performa... | 3061 | 2025-08-18 |
...
| [fasttuple](https://github.com/boundary/fasttuple) | Collections that are laid out adjacently in both on- and off-heap memory. | 143 | 2021-12-25 |
...
| [java-string-similarity](https://github.com/tdebatty/java-string-similarity) | String similarity and distance measures, including Levenshtein edit distance and sibblings, Jaro-... | 2726 | 2022-06-01 |
...
| [Koloboke](https://github.com/OpenHFT/Koloboke) | Java Collections til the last breadcrumb of memory and performance. | 1016 | 2017-02-01 |
...
| [lmdbjni](https://github.com/deephacks/lmdbjni) | Java API to LMDB (HawtJNI) which is an ultra-fast, ultra-compact key-value embedded data store wr... | 205 | 2021-05-28 |
| [lmdbjava](https://github.com/lmdbjava/lmdbjava) | Java API to LMDB (JNR) which is an ultra-fast, ultra-compact key-value embedded data store writte... | 841 | 2025-02-20 |
...
| [lwjgl3](https://github.com/LWJGL/lwjgl3) | Java library that enables cross-platform access to popular native APIs useful in the development ... | 5106 | 2025-08-03 |
| [mph-table](https://github.com/indeedeng/mph-table) | Minimal Perfect Hash Tables are an immutable key/value store with efficient space utilization and... | 100 | 2023-07-11 |
...
| [onyx-java](https://github.com/onyx-platform/onyx-java) | Mirrors the Onyx Platform core API by providing a Java equivalent for each component of an Onyx w... | 5 | 2017-06-01 |
...
| [RTree2D](https://github.com/Sizmek/rtree2d) | RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest an... | 137 | 2025-08-16 |
...
| [transducers-java](https://github.com/cognitect-labs/transducers-java) | Composable algorithmic transformations independent from the context of their input and output sou... | 118 | 2023-06-03 |
| [wire](https://github.com/square/wire) | Clean, lightweight protocol buffers for Android and Java. | 4361 | 2025-08-18 |
| [Zero-Allocation-Hashing](https://github.com/OpenHFT/Zero-Allocation-Hashing) | Hashing any sequences of bytes in Java, including all kinds of primitive arrays, buffers, CharSeq... | 814 | 2025-07-22 |
...
| [Rembulan](https://github.com/mjanicek/rembulan) | Rembulan is an implementation of Lua 5.3 for the JVM, written in pure Java with minimal dependenc... | 165 | 2020-04-22 |
...
| [J2ObjC](https://github.com/google/j2objc) | Translator from Java source to Objective-C code. Keeps shared code between iOS native apps and An... | 6026 | 2025-08-19 |
...
| [JXIO](https://github.com/accelio/JXIO) | Java API over AccelIO (C library), a high-performance asynchronous reliable messaging and RPC lib... | 82 | 2017-01-15 |
| [K3PO](https://github.com/k3po/k3po) | Create arbitrary network traffic and behavior to certify whether a network endpoint behaves corre... | 49 | 2022-11-16 |
...
| [proteus-java](https://github.com/netifi-proteus/proteus-java) | Proteus Java Client based on RSocket. | 43 | 2019-05-03 |
