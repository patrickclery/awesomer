...
| 2 | [Holehe](../r/megadose~holehe.md) | 14,901 | +657 | +2,745 | +3,634 |
| 3 | [Sherlock](../r/sherlock-project~sherlock.md) | 91,392 | +503 | +2,000 | +6,401 |
| 4 | [SpiderFoot](../r/smicallef~spiderfoot.md) | 22,071 | +234 | +1,591 | +3,899 |
| 5 | [uBlock Origin](../r/gorhill~ublock.md) | 67,788 | +214 | +854 | +2,321 |
| 6 | [Maigret](../r/soxoj~maigret.md) | 37,478 | +167 | +752 | +4,448 |
| 7 | [MailAccess](../r/katrielmoses~mailaccess.md) | 1,328 | +159 | +962 | +1,192 |
| 8 | [Blackbird](../r/p1ngul1n0~blackbird.md) | 8,072 | +155 | +557 | +1,934 |
| 9 | [SecLists](../r/danielmiessler~seclists.md) | 73,472 | +153 | +651 | +1,917 |
| 10 | [ChangeDetection.io Open Source](../r/dgtlmoon~changedetection.io.md) | 33,842 | +109 | +733 | +1,851 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Amass](../r/owasp-amass~amass.md) | In-depth attack surface mapping and asset discovery | 15,150 | +49 |
| [dnsx](../r/projectdiscovery~dnsx.md) | dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-suppli | 2,865 | +7 |
...
| [NOX](../r/nox-project~nox-framework.md) | High-performance OSINT/CTI framework for automated identity pivoting and risk analysis across 120+ sources. | 324 | +1 |
...
| [Domain Hunter](../r/whitebite~domain-hunter.md) | Check bulk domain availability 100% in your browser — free, open-source RDAP domain checker & name generator. 140+ TLDs, | 16 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Holehe](../r/megadose~holehe.md) | holehe allows you to check if the mail is used on different sites like twitter, instagram and will retrieve information  | 14,901 | +657 |
| [MailAccess](../r/katrielmoses~mailaccess.md) | Free email OSINT tool, 2500+ platforms, identity clustering, breach detection. No API keys required. pip install mailacc | 1,328 | +159 |
| [Blackbird](../r/p1ngul1n0~blackbird.md) | An OSINT tool to search for accounts by username and email in social networks. | 8,072 | +155 |
| [user-scanner](../r/kaifcodec~user-scanner.md) | 🕵️‍♂️ (2-in-1) Email & Username OSINT suite featuring native MCP support for deep data extraction just from a single Em | 4,765 | +71 |
| [Ghunt](../r/mxrch~ghunt.md) | 🕵️‍♂️ Offensive Google framework. | 19,547 | +34 |
| [h8mail](../r/khast3x~h8mail.md) | Email OSINT & Password breach hunting tool, locally or using premium services. Supports chasing down related email | 5,291 | +19 |
...
| [Fb-sleep-stats](../r/sqren~fb-sleep-stats.md) | Use Facebook to track your friends’ sleeping habits | 1,709 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Perspective](../r/finos~perspective.md) | A data visualization and analytics component, especially well-suited for large and/or streaming datasets. | 11,188 | +15 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Osintgram](../r/datalux~osintgram.md) | Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any u | 14,386 | +89 |
| [Osintgraph](../r/xd-mhloo~osintgraph.md) | About Osintgraph is an open-source tool that collects Instagram data, followers, and followees, storing them in Neo4j. I | 949 | +36 |
...
| [instagram_monitor](../r/misiektoja~instagram_monitor.md) | Track Instagram users' activities, profile changes and capture content with beautiful dashboards and instant notificatio | 1,454 | +12 |
| [InstagramPrivSniffer](../r/obitouka~instagramprivsniffer.md) |  First ever tool to view "Instagram private posts" anonymously  | 1,001 | +12 |
| [insto](../r/subzeroid~insto.md) | 🔍 Interactive Instagram OSINT CLI with pluggable HikerAPI and aiograpi backends | 107 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [SpiderFoot](../r/smicallef~spiderfoot.md) | SpiderFoot automates OSINT for threat intelligence and mapping your attack surface. | 22,071 | +234 |
| [The Harvester](../r/laramies~theharvester.md) | E-mails, subdomains and names Harvester - OSINT  | 17,359 | +94 |
| [CrowdSec](../r/crowdsecurity~crowdsec.md) | CrowdSec - the open-source and participative security solution offering crowdsourced protection against malicious IPs an | 14,825 | +73 |
| [ReconFTW](../r/six2dez~reconftw.md) | reconFTW is a tool designed to perform automated recon on a target domain by running the best set of tools to perform sc | 8,105 | +30 |
| [Photon](../r/s0md3v~photon.md) | Incredibly fast crawler designed for OSINT. | 13,201 | +23 |
| [OpenGraph Intel (OGI)](../r/khashashin~ogi.md) | Open Source Link Analysis & OSINT Framework | 296 | +6 |
| [PRISM](../r/novacode37~prism-platform.md) | Self-hosted OSINT platform. Point it at a domain, IP, email, phone or username and 22+ modules run in parallel: WHOIS, D | 227 | +5 |
| [Waybackurls](../r/tomnomnom~waybackurls.md) | Fetch all the URLs that the Wayback Machine knows about for a domain | 4,560 | +5 |
| [FOCA](../r/elevenpaths~foca.md) | Tool to find metadata and hidden information in the documents. | 3,631 | +4 |
...
| [sn0int](../r/kpcyrd~sn0int.md) | Semi-automatic OSINT framework and package manager | 2,532 | +4 |
...
| [OsintStalker](../r/milo2012~osintstalker.md) | osintstalker | 723 | +0 |
...
| [Zen](../r/s0md3v~zen.md) | Find emails of Github users | 600 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [PhoneInfoga](../r/sundowndev~phoneinfoga.md) | Information gathering framework for phone numbers | 17,850 | +92 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Oblivion](../r/loseys~oblivion.md) | Data leak checker & OSINT Tool | 598 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Arctic Shift](../r/arthurheitmann~arctic_shift.md) | Making Reddit data accessible to researchers, moderators and everyone else.  Interact with the data through large dumps, | 1,505 | +40 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [SecLists](../r/danielmiessler~seclists.md) | SecLists is the security tester's companion. It's a collection of multiple types of lists used during security assessmen | 73,472 | +153 |
| [awesome-pentest](../r/enaqx~awesome-pentest.md) | A collection of awesome penetration testing resources, tools and other shiny things | 27,183 | +77 |
| [personal-security-checklist](../r/lissy93~personal-security-checklist.md) | 🔒 A compiled checklist of 300+ tips for protecting digital security and privacy in 2026 | 22,310 | +57 |
| [awesome-privacy](../r/lissy93~awesome-privacy.md) | 🦄  A curated list of privacy & security-focused software and services | 9,870 | +47 |
...
| [OSINT-BIBLE](../r/frangelbarrera~osint-bible.md) | Comprehensive 2026 OSINT guide — 450+ tools, AI intelligence, methodologies & ethics across 35 sections for investigatio | 913 | +16 |
...
| [awesome-forensics](../r/cugu~awesome-forensics.md) | ⭐️ A curated list of awesome forensic analysis tools and resources | 5,183 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Steam-OSINT](../r/matiash26~steam-osint.md) | This tool will help you find a mutual friend | 98 | +0 |
...
| [Telerecon](../r/sockysec~telerecon.md) | A reconnaissance framework for researching and investigating Telegram.  | 1,325 | +3 |
| [TOsint](../r/drego85~tosint.md) | Tosint is a Telegram OSINT tool that extracts actionable intelligence from bot tokens and chat IDs for security investig | 848 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [VoidAccess](../r/katrielmoses~voidaccess.md) | Self-hosted dark web OSINT platform. Automated threat intelligence from query to graph in 13 steps. Free alternative to  | 690 | +28 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Sherlock](../r/sherlock-project~sherlock.md) | Hunt down social media accounts by username across social networks | 91,392 | +503 |
| [Maigret](../r/soxoj~maigret.md) | 🕵️‍♂️ Collect a dossier on a person by username from 3000+ sites | 37,478 | +167 |
| [Blackbird](../r/p1ngul1n0~blackbird.md) | An OSINT tool to search for accounts by username and email in social networks. | 8,072 | +155 |
| [user-scanner](../r/kaifcodec~user-scanner.md) | 🕵️‍♂️ (2-in-1) Email & Username OSINT suite featuring native MCP support for deep data extraction just from a single Em | 4,765 | +71 |
| [Social Analyzer](../r/qeeqbox~social-analyzer.md) | API, CLI, and Web App for analyzing and finding a person's profile in 1000 social media \ websites | 24,016 | +49 |
...
| [Seekr](../r/seekr-osint~seekr.md) | A multi-purpose OSINT toolkit with a neat web-interface. | 869 | +1 |
...
| [Tubuep](../r/bibanon~tubeup.md) | Use yt-dlp to download video/metadata and upload to the Internet Archive. | 516 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Wayback Machine Archiver](../r/jsvine~waybackpack.md) | Download the entire Wayback Machine archive for a given URL. | 3,231 | +2 |
| [Wayback-Archive](../r/geiserx~wayback-archive.md) | Download complete websites from the Wayback Machine with full asset preservation for offline viewing | 33 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ChangeDetection.io Open Source](../r/dgtlmoon~changedetection.io.md) | Best and simplest tool for website change detection, web page monitoring, and website change alerts. Perfect for trackin | 33,842 | +109 |
...
---
*Updated: 2026-09-13 | [View live site ↗](https://patrickclery.com/awesomer/l/osint/)*
