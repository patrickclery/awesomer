...
|---|------|-------|----|-----|-----|
| 1 | [Kubernetes](../r/kubernetes~kubernetes.md) | 127,737 | +597 | +3,231 | +4,619 |
| 2 | [Trivy](../r/aquasecurity~trivy.md) | 37,920 | +133 | +497 | +1,449 |
| 3 | [Dockerlings](../r/furkan~dockerlings.md) | 1,032 | +129 | +133 | +142 |
| 4 | [Drone](../r/drone~drone.md) | 38,353 | +114 | +379 | +1,536 |
| 5 | [Træfɪk](../r/containous~traefik.md) | 64,846 | +102 | +398 | +1,189 |
| 6 | [Komodo](../r/mbecker20~komodo.md) | 12,296 | +92 | +351 | +896 |
| 7 | [colima](../r/abiosoft~colima.md) | 30,818 | +92 | +442 | +1,487 |
| 8 | [Arcane](../r/getarcaneapp~arcane.md) | 7,396 | +85 | +386 | +1,621 |
| 9 | [lazydocker](../r/jesseduffield~lazydocker.md) | 52,831 | +79 | +332 | +1,452 |
| 10 | [podman](../r/containers~libpod.md) | 32,871 | +70 | +277 | +831 |
...
| [Awesome Compose](../r/docker~awesome-compose.md) | Awesome Docker Compose samples | 46,326 | +53 |
...
| [pglayers](../r/pglayers~pglayers.md) | PostgreSQL Docker images with the extensions you actually need -- pre-built, composable, no compilation. | 160 | +1 |
...
| [apko](../r/chainguard-dev~apko.md) | Build OCI images from APK packages directly without Dockerfile | 1,672 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Kubernetes](../r/kubernetes~kubernetes.md) | Production-Grade Container Scheduling and Management | 127,737 | +597 |
| [Trivy](../r/aquasecurity~trivy.md) | Find vulnerabilities, misconfigurations, secrets, SBOM in containers, Kubernetes, code repositories, clouds and more | 37,920 | +133 |
| [Træfɪk](../r/containous~traefik.md) | The Cloud Native Application Proxy | 64,846 | +102 |
| [Komodo](../r/mbecker20~komodo.md) | 🦎 a tool to build and deploy software on many servers 🦎 | 12,296 | +92 |
| [lazydocker](../r/jesseduffield~lazydocker.md) | The lazier way to manage everything docker | 52,831 | +79 |
| [podman](../r/containers~libpod.md) | Podman: A tool for managing OCI containers and pods. | 32,871 | +70 |
| [Portainer](../r/portainer~portainer.md) | Making Docker and Kubernetes management easy. | 38,505 | +70 |
| [Nginx Proxy Manager](../r/jc21~nginx-proxy-manager.md) | Docker container for managing Nginx proxy hosts with a simple, powerful interface | 34,138 | +64 |
| [dockge](../r/louislam~dockge.md) | A fancy, easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager | 24,345 | +59 |
| [Syft](../r/anchore~syft.md) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 9,563 | +34 |
| [Checkov](../r/bridgecrewio~checkov.md) | Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images a | 9,001 | +24 |
| [dive](../r/wagoodman~dive.md) | A tool for exploring each layer in a docker image | 54,561 | +23 |
...
| [Nomad](../r/hashicorp~nomad.md) | Nomad is an easy-to-use, flexible, and performant workload orchestrator that can deploy a mix of microservice, batch, co | 16,945 | +22 |
| [Sysdig Falco](../r/falcosecurity~falco.md) | Cloud Native Runtime Security | 9,376 | +20 |
| [skopeo](../r/containers~skopeo.md) | Work with remote images registries - retrieving information, images, signing content | 11,232 | +19 |
| [Rancher](../r/rancher~rancher.md) | Complete container management platform | 25,909 | +15 |
| [podman-compose](../r/containers~podman-compose.md) | a script to run docker-compose.yml using podman | 6,214 | +14 |
| [cAdvisor](../r/google~cadvisor.md) | Analyzes resource usage and performance characteristics of running containers. | 19,422 | +13 |
| [oxker](../r/mrjackwills~oxker.md) | A simple tui to view & control docker containers  | 1,839 | +11 |
| [caprover](../r/caprover~caprover.md) | Scalable PaaS (automated Docker+nginx) - aka Heroku on Steroids | 15,161 | +8 |
| [Autoheal](https://github.com/willfarrell/docker-autoheal) | Monitor and restart unhealthy docker containers. | 1,995 | +7 |
| [caddy-docker-proxy](../r/lucaslorentz~caddy-docker-proxy.md) | Caddy as a reverse proxy for Docker | 4,647 | +7 |
| [Deepfence Threat Mapper](../r/deepfence~threatmapper.md) | Open Source Cloud Native Application Protection Platform (CNAPP) | 5,323 | +6 |
...
| [netshoot](../r/nicolaka~netshoot.md) | a Docker + Kubernetes network trouble-shooting swiss-army container | 10,997 | +6 |
...
| [oscap-docker](../r/openscap~openscap.md) | NIST Certified SCAP 1.2 toolkit | 1,816 | +5 |
...
| [Clair](../r/quay~clair.md) | Vulnerability Static Analysis for Containers | 11,058 | +2 |
...
| [Flannel](../r/coreos~flannel.md) | flannel is a network fabric for containers, designed for Kubernetes | 9,539 | +2 |
...
| [REX-Ray](https://github.com/rexray/rexray) | REX-Ray is a container storage orchestration engine enabling persistence for cloud native workloads | 2,222 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [doco-cd](../r/kimdre~doco-cd.md) | Docker Compose Continuous Deployment | 1,662 | +17 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Gantry (Desktop)](https://github.com/getgantry/gantry) | Native macOS app for managing and monitoring Docker — local and over SSH. Agent-ready: built-in MCP server and App Inten | 64 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Drone](../r/drone~drone.md) | Harness Open Source is an end-to-end developer platform with Source Control Management, CI/CD Pipelines, Hosted Develope | 38,353 | +114 |
| [coder](../r/coder~coder.md) | Secure environments for developers and their agents | 14,464 | +54 |
| [Pumba](../r/alexei-led~pumba.md) | Chaos testing, network emulation, and stress testing tool for containers | 3,151 | +30 |
| [Diun](../r/crazy-max~diun.md) | Receive notifications when an image is updated on a Docker registry | 4,918 | +25 |
| [OpenFaaS](../r/openfaas~faas.md) | OpenFaaS - Serverless Functions Made Simple | 26,241 | +7 |
| [dockcheck](../r/mag37~dockcheck.md) | CLI tool to automate docker image updates. Interactive or unattended with notifications, image backups, autoprune, no pr | 2,504 | +5 |
...
| [Preevy](../r/livecycle~preevy.md) | Quickly deploy preview environments to the cloud! | 2,231 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Harbor](../r/goharbor~harbor.md) | An open source trusted cloud native registry project that stores, signs, and scans content. | 29,369 | +53 |
| [Hadolint](../r/hadolint~hadolint.md) | Dockerfile linter, validate inline bash, written in Haskell | 12,404 | +11 |
| [distroless](../r/googlecontainertools~distroless.md) | 🥑  Language focused docker images, minus the operating system.   | 23,074 | +10 |
| [BuildKit](../r/moby~buildkit.md) | concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit | 10,267 | +9 |
| [DockerSlim](../r/docker-slim~docker-slim.md) | Slim(toolkit): Don't change anything in your container image and minify it by up to 30x (and for compiled languages even | 23,411 | +8 |
| [supercronic](../r/aptible~supercronic.md) | Cron for containers | 2,637 | +8 |
| [buildah](../r/containers~buildah.md) | A tool that facilitates building OCI images. | 9,016 | +6 |
| [Dragonfly](../r/dragonflyoss~dragonfly2.md) | Delivers efficient, stable, and secure data distribution and acceleration powered by P2P technology, with an optional co | 3,328 | +6 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [colima](../r/abiosoft~colima.md) | Container runtimes on macOS (and Linux) with minimal setup | 30,818 | +92 |
| [gVisor](../r/google~gvisor.md) | Application Kernel for Containers | 19,327 | +48 |
| [containerd](../r/containerd~containerd.md) | An open and reliable container runtime | 21,296 | +26 |
| [youki](../r/youki-dev~youki.md) | A container runtime written in Rust | 7,597 | +14 |
| [runc](../r/opencontainers~runc.md) | CLI tool for spawning and running containers according to the OCI specification | 13,445 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [InfraCanvas](https://github.com/bytestrix/InfraCanvas) | Live Docker & Kubernetes infrastructure visualization - containers, pods, volumes, and networks in one visual map. No VP | 80 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Moby](../r/moby~moby.md) | The Moby Project - a collaborative project for the container ecosystem to assemble container-based systems | 72,106 | +20 |
| [Docker Compose](../r/docker~compose.md) | Define and run multi-container applications with Docker | 38,160 | +12 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [oras](../r/oras-project~oras.md) | OCI registry client - managing content like artifacts, images, packages | 2,428 | +12 |
| [go-containerregistry](../r/google~go-containerregistry.md) | Go library and CLIs for working with container registries | 4,047 | +8 |
| [regctl](../r/regclient~regclient.md) | Docker and OCI Registry Client in Go and tooling using those libraries. | 1,931 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [BunkerWeb](../r/bunkerity~bunkerweb.md) | 🛡️ Open-source and cloud-native Web Application Firewall (WAF) | 10,950 | +30 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Grype](../r/anchore~grype.md) | A vulnerability scanner for container images and filesystems | 12,884 | +29 |
| [docker-socket-proxy](../r/tecnativa~docker-socket-proxy.md) | Proxy over your Docker socket to restrict which requests it accepts | 2,765 | +21 |
...
| [in-toto](../r/in-toto~in-toto.md) | in-toto is a framework to protect supply chain integrity. | 1,038 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Cloud Native Landscape](../r/cncf~landscape.md) | 🌄 The Cloud Native Interactive Landscape filters and sorts hundreds of projects and products, and shows details includi | 9,990 | +11 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Arcane](../r/getarcaneapp~arcane.md) | Modern Docker Management, Designed for Everyone | 7,396 | +85 |
...
---
*Updated: 2026-09-15 | [View live site ↗](https://patrickclery.com/awesomer/l/docker/)*
