...
|---|------|-------|----|-----|-----|
| 1 | [Kubernetes](../r/kubernetes~kubernetes.md) | 127,754 | +597 | +3,264 | +4,673 |
| 2 | [Trivy](../r/aquasecurity~trivy.md) | 37,940 | +133 | +496 | +1,451 |
| 3 | [Dockerlings](../r/furkan~dockerlings.md) | 1,032 | +129 | +133 | +142 |
| 4 | [Drone](../r/drone~drone.md) | 38,365 | +114 | +378 | +1,518 |
| 5 | [Træfɪk](../r/containous~traefik.md) | 64,860 | +102 | +395 | +1,191 |
| 6 | [Komodo](../r/mbecker20~komodo.md) | 12,305 | +92 | +351 | +899 |
| 7 | [colima](../r/abiosoft~colima.md) | 30,836 | +92 | +449 | +1,491 |
| 8 | [Arcane](../r/getarcaneapp~arcane.md) | 7,412 | +85 | +390 | +1,627 |
| 9 | [lazydocker](../r/jesseduffield~lazydocker.md) | 52,844 | +79 | +333 | +1,467 |
| 10 | [podman](../r/containers~libpod.md) | 32,877 | +70 | +277 | +828 |
...
| [Awesome Compose](../r/docker~awesome-compose.md) | Awesome Docker Compose samples | 46,343 | +53 |
...
| [pglayers](../r/pglayers~pglayers.md) | PostgreSQL Docker images with the extensions you actually need -- pre-built, composable, no compilation. | 161 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ko](../r/ko-build~ko.md) | Build and deploy Go applications | 8,517 | +9 |
| [buildx](../r/docker~buildx.md) | Docker CLI plugin for extended build capabilities with BuildKit | 4,500 | +6 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Self Hosted Runner](../r/youssefbrr~self-hosted-runner.md) | Dockerized solution for setting up a self-hosted GitHub Actions runner. Easily deploy and scale your runners using Docke | 138 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Kubernetes](../r/kubernetes~kubernetes.md) | Production-Grade Container Scheduling and Management | 127,754 | +597 |
| [Trivy](../r/aquasecurity~trivy.md) | Find vulnerabilities, misconfigurations, secrets, SBOM in containers, Kubernetes, code repositories, clouds and more | 37,940 | +133 |
| [Træfɪk](../r/containous~traefik.md) | The Cloud Native Application Proxy | 64,860 | +102 |
| [Komodo](../r/mbecker20~komodo.md) | 🦎 a tool to build and deploy software on many servers 🦎 | 12,305 | +92 |
| [lazydocker](../r/jesseduffield~lazydocker.md) | The lazier way to manage everything docker | 52,844 | +79 |
| [podman](../r/containers~libpod.md) | Podman: A tool for managing OCI containers and pods. | 32,877 | +70 |
| [Portainer](../r/portainer~portainer.md) | Making Docker and Kubernetes management easy. | 38,510 | +70 |
| [Nginx Proxy Manager](../r/jc21~nginx-proxy-manager.md) | Docker container for managing Nginx proxy hosts with a simple, powerful interface | 34,147 | +64 |
| [dockge](../r/louislam~dockge.md) | A fancy, easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager | 24,361 | +59 |
| [Syft](../r/anchore~syft.md) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 9,567 | +34 |
| [Checkov](../r/bridgecrewio~checkov.md) | Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images a | 9,003 | +24 |
| [dive](../r/wagoodman~dive.md) | A tool for exploring each layer in a docker image | 54,567 | +23 |
| [Docker Volume Backup](../r/offen~docker-volume-backup.md) | Backup Docker volumes locally or to any S3, WebDAV, Azure Blob Storage, Dropbox, Google Drive or SSH compatible storage | 4,009 | +23 |
| [Nomad](../r/hashicorp~nomad.md) | Nomad is an easy-to-use, flexible, and performant workload orchestrator that can deploy a mix of microservice, batch, co | 16,965 | +22 |
| [Sysdig Falco](../r/falcosecurity~falco.md) | Cloud Native Runtime Security | 9,382 | +20 |
| [skopeo](../r/containers~skopeo.md) | Work with remote images registries - retrieving information, images, signing content | 11,233 | +19 |
| [Rancher](../r/rancher~rancher.md) | Complete container management platform | 25,916 | +15 |
| [podman-compose](../r/containers~podman-compose.md) | a script to run docker-compose.yml using podman | 6,216 | +14 |
| [cAdvisor](../r/google~cadvisor.md) | Analyzes resource usage and performance characteristics of running containers. | 19,426 | +13 |
| [oxker](../r/mrjackwills~oxker.md) | A simple tui to view & control docker containers  | 1,841 | +11 |
| [caprover](../r/caprover~caprover.md) | Scalable PaaS (automated Docker+nginx) - aka Heroku on Steroids | 15,162 | +8 |
| [Autoheal](https://github.com/willfarrell/docker-autoheal) | Monitor and restart unhealthy docker containers. | 1,996 | +7 |
| [caddy-docker-proxy](../r/lucaslorentz~caddy-docker-proxy.md) | Caddy as a reverse proxy for Docker | 4,647 | +7 |
| [Deepfence Threat Mapper](../r/deepfence~threatmapper.md) | Open Source Cloud Native Application Protection Platform (CNAPP) | 5,321 | +6 |
| [docker rollout](../r/wowu~docker-rollout.md) | 🚀 Zero Downtime Deployment for Docker Compose | 3,335 | +6 |
| [KICS](../r/checkmarx~kics.md) | Find security vulnerabilities, compliance issues, and infrastructure misconfigurations early in the development cycle of | 2,699 | +6 |
| [netshoot](../r/nicolaka~netshoot.md) | a Docker + Kubernetes network trouble-shooting swiss-army container | 10,998 | +6 |
| [kompose](../r/kubernetes~kompose.md) | Convert Compose to Kubernetes | 10,621 | +5 |
| [lazyjournal](../r/lifailon~lazyjournal.md) | TUI for viewing logs from journald, auditd, file system, Docker and Podman containers, Compose stacks and Kubernetes pod | 1,405 | +5 |
| [oscap-docker](../r/openscap~openscap.md) | NIST Certified SCAP 1.2 toolkit | 1,815 | +5 |
| [Dokku](../r/dokku~dokku.md) | A docker-powered PaaS that helps you build and manage the lifecycle of applications | 32,143 | +4 |
| [lxc](../r/lxc~lxc.md) | LXC - Linux Containers | 5,261 | +4 |
| [cri-o](../r/cri-o~cri-o.md) | Open Container Initiative-based implementation of Kubernetes Container Runtime Interface | 5,659 | +3 |
| [d4s](../r/jr-k~d4s.md) | 🍊 A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomi | 129 | +3 |
| [docker-bench-security](../r/docker~docker-bench-security.md) | The Docker Bench for Security is a script that checks for dozens of common best-practices around deploying Docker contai | 9,704 | +3 |
| [Clair](../r/quay~clair.md) | Vulnerability Static Analysis for Containers | 11,057 | +2 |
...
| [Flannel](../r/coreos~flannel.md) | flannel is a network fabric for containers, designed for Kubernetes | 9,540 | +2 |
| [Let's Encrypt Nginx-proxy Companion](../r/nginx-proxy~docker-letsencrypt-nginx-proxy-companion.md) | Automated ACME SSL certificate generation for nginx-proxy | 7,727 | +2 |
| [dcinja](https://github.com/Falldog/dcinja) | The smallest binary size of template engine, born for docker image | 15 | +1 |
...
| [goManageDocker](https://github.com/ajayd-san/gomanagedocker) | TUI tool to manage your docker images, containers and volumes 🚀 | 641 | +1 |
| [Grafeas](../r/grafeas~grafeas.md) | Artifact Metadata API | 1,569 | +1 |
| [OpenResty Manager](../r/safe3~openresty-manager.md) | Modern, secure, and elegant server control panel, alternative to OpenResty Edge and Nginx Proxy Manager. | 1,453 | +1 |
| [Simple Docker UI](https://github.com/felixgborrego/simple-docker-ui) | Native Docker UI implemented using Scala.js and React - DEPRECATED | 604 | +1 |
| [Stevedore](../r/slonopotamus~stevedore.md) | 🚢 Docker distribution for Windows Containers that Just Works | 386 | +1 |
| [supdock](https://github.com/segersniels/supdock) | What's Up, Doc(ker)? A convenient way to interact with the docker daemon using prompts. | 88 | +1 |
| [Swarm-cronjob](../r/crazy-max~swarm-cronjob.md) | Create jobs on a time-based schedule on Docker Swarm | 884 | +1 |
| [Swarmpit](../r/swarmpit~swarmpit.md) | Lightweight AI-friendly Docker Swarm management | 3,491 | +1 |
...
| [Composerize](../r/magicmark~composerize.md) | 🏃→🎼  docker run asdlksjfksdf > docker-composerize up | 3,758 | +0 |
...
| [Doku](../r/amerkurev~doku.md) | 💽 Doku - Docker disk usage dashboard | 447 | +0 |
| [dprs](https://github.com/durableprogramming/dprs) | A developer-focused TUI for managing Docker containers with real-time log streaming and container management. Built with | 40 | +0 |
| [dry](../r/moncho~dry.md) | dry - A Docker manager for the terminal @ | 3,276 | +0 |
| [Exoframe](../r/exoframejs~exoframe.md) | Exoframe is a self-hosted tool that allows simple one-command deployments using Docker | 1,156 | +0 |
...
| [Pipework](https://github.com/jpetazzo/pipework) | Software-Defined Networking tools for LXC (LinuX Containers) | 4,252 | +0 |
...
| [docker-swarm-visualizer](https://github.com/dockersamples/docker-swarm-visualizer) | A visualizer for Docker Swarm Mode using the Docker Remote API, Node.JS, and D3 | 3,338 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Local Docker DB](https://github.com/alexmacarthur/local-docker-db) | A bunch o' Docker Compose files used to quickly spin up local databases.  | 299 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [doco-cd](../r/kimdre~doco-cd.md) | Docker Compose Continuous Deployment | 1,664 | +17 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Gantry (Desktop)](https://github.com/getgantry/gantry) | Native macOS app for managing and monitoring Docker — local and over SSH. Agent-ready: built-in MCP server and App Inten | 65 | +1 |
...
| [Laradock](../r/laradock~laradock.md) | Full PHP development environment for Docker. Run Laravel, Symfony, CodeIgniter, Phalcon, WordPress, Drupal, Magento, Moo | 12,674 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Drone](../r/drone~drone.md) | Harness Open Source is an end-to-end developer platform with Source Control Management, CI/CD Pipelines, Hosted Develope | 38,365 | +114 |
| [coder](../r/coder~coder.md) | Secure environments for developers and their agents | 14,544 | +54 |
| [Pumba](../r/alexei-led~pumba.md) | Chaos testing, network emulation, and stress testing tool for containers | 3,152 | +30 |
| [Diun](../r/crazy-max~diun.md) | Receive notifications when an image is updated on a Docker registry | 4,919 | +25 |
| [OpenFaaS](../r/openfaas~faas.md) | OpenFaaS - Serverless Functions Made Simple | 26,241 | +7 |
...
| [dockerode](../r/apocas~dockerode.md) | Docker + Node = Dockerode (Node.js module for Docker's Remote API) | 4,947 | +5 |
| [udocker](https://github.com/indigo-dc/udocker) | A basic user tool to execute simple docker containers in batch or interactive systems without root privileges. | 1,788 | +5 |
| [Preevy](../r/livecycle~preevy.md) | Quickly deploy preview environments to the cloud! | 2,230 | +3 |
| [Apache OpenWhisk](../r/apache~openwhisk.md) | Apache OpenWhisk is an open source serverless cloud platform | 6,795 | +2 |
...
| [Docker.DotNet](https://github.com/Microsoft/Docker.DotNet) | 🐳 .NET (C#) Client Library for Docker API | 2,415 | +1 |
...
| [Kurtosis](../r/kurtosis-tech~kurtosis.md) | A platform for packaging and launching blockchain infra. Think docker compose for blockchain | 552 | +1 |
| [Lando](../r/lando~lando.md) | A development tool for all your projects that is fast, easy, powerful and liberating | 4,239 | +1 |
...
| [Defang](../r/defanglabs~defang.md) | Defang Deploy CLI. Develop Once, Deploy Anywhere. Take your app from Docker Compose to a secure and scalable deployment  | 166 | +0 |
...
| [Jaypore CI](https://github.com/theSage21/jaypore_ci) | A small, very flexible, powerful CI system. Works offline and is configured in Python. | 38 | +0 |
...
| [sbt-docker](https://github.com/marcuslonnberg/sbt-docker) | Create Docker images directly from sbt | 731 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Harbor](../r/goharbor~harbor.md) | An open source trusted cloud native registry project that stores, signs, and scans content. | 29,390 | +53 |
| [Hadolint](../r/hadolint~hadolint.md) | Dockerfile linter, validate inline bash, written in Haskell | 12,409 | +11 |
| [distroless](../r/googlecontainertools~distroless.md) | 🥑  Language focused docker images, minus the operating system.   | 23,075 | +10 |
| [BuildKit](../r/moby~buildkit.md) | concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit | 10,270 | +9 |
| [DockerSlim](../r/docker-slim~docker-slim.md) | Slim(toolkit): Don't change anything in your container image and minify it by up to 30x (and for compiled languages even | 23,410 | +8 |
| [supercronic](../r/aptible~supercronic.md) | Cron for containers | 2,641 | +8 |
| [buildah](../r/containers~buildah.md) | A tool that facilitates building OCI images. | 9,017 | +6 |
| [Dragonfly](../r/dragonflyoss~dragonfly2.md) | Delivers efficient, stable, and secure data distribution and acceleration powered by P2P technology, with an optional co | 3,331 | +6 |
| [Ofelia](../r/mcuadros~ofelia.md) | A docker job scheduler (aka. crontab for docker) | 3,989 | +5 |
| [HPC Container Maker](../r/nvidia~hpc-container-maker.md) | HPC Container Maker | 517 | +3 |
| [Kraken](../r/uber~kraken.md) | P2P Docker registry capable of distributing TBs of data in seconds | 6,745 | +3 |
...
| [GoSu](../r/tianon~gosu.md) | Simple Go-based setuid+setgid+setgroups+exec | 5,007 | +1 |
...
| [img](https://github.com/genuinetools/img) | Standalone, daemon-less, unprivileged Dockerfile and OCI compatible container image builder. | 3,988 | +0 |
| [is-docker](https://github.com/sindresorhus/is-docker) | Check if the process is running inside a Docker container | 234 | +0 |
...
| [runlike](../r/lavie~runlike.md) | Given an existing docker container, prints the command line necessary to run a copy of it. | 2,942 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Dofigen](https://github.com/lenra-io/dofigen) | Dofigen is a Dockerfile generator using a simplified description in YAML or JSON format | 72 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [colima](../r/abiosoft~colima.md) | Container runtimes on macOS (and Linux) with minimal setup | 30,836 | +92 |
| [gVisor](../r/google~gvisor.md) | Application Kernel for Containers | 19,335 | +48 |
| [containerd](../r/containerd~containerd.md) | An open and reliable container runtime | 21,298 | +26 |
| [youki](../r/youki-dev~youki.md) | A container runtime written in Rust | 7,601 | +14 |
| [runc](../r/opencontainers~runc.md) | CLI tool for spawning and running containers according to the OCI specification | 13,447 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [BomLens](https://github.com/sktelecom/bomlens) | BomLens — a local-first SBOM generator & open-source risk assessor (CycloneDX). Produce an SBOM, an open-source notice,  | 19 | +0 |
| [Docker Scout](../r/docker~scout-cli.md) | Docker Scout CLI | 453 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Drydock](../r/codeswhat~drydock.md) | Open source container update monitoring — 23 registries, 20 notification triggers, audit log, OIDC auth, Prometheus metr | 253 | +27 |
| [Maintenant](../r/kolapsis~maintenant.md) | Self-hosted monitoring for Docker, Kubernetes and uptime. Single Go binary, no agent config, live alerts. Drop a contain | 504 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [InfraCanvas](https://github.com/bytestrix/InfraCanvas) | Live Docker & Kubernetes infrastructure visualization - containers, pods, volumes, and networks in one visual map. No VP | 81 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Moby](../r/moby~moby.md) | The Moby Project - a collaborative project for the container ecosystem to assemble container-based systems | 72,099 | +20 |
| [Docker Compose](../r/docker~compose.md) | Define and run multi-container applications with Docker | 38,167 | +12 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [NORA](../r/getnora-io~nora.md) | Lightweight multi-format artifact registry. 15 formats: Docker, Maven, npm, PyPI, Cargo, Go, Raw, RubyGems, Terraform, A | 297 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [oras](../r/oras-project~oras.md) | OCI registry client - managing content like artifacts, images, packages | 2,430 | +12 |
| [go-containerregistry](../r/google~go-containerregistry.md) | Go library and CLIs for working with container registries | 4,050 | +8 |
| [regctl](../r/regclient~regclient.md) | Docker and OCI Registry Client in Go and tooling using those libraries. | 1,933 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Grype](../r/anchore~grype.md) | A vulnerability scanner for container images and filesystems | 12,890 | +29 |
| [docker-socket-proxy](../r/tecnativa~docker-socket-proxy.md) | Proxy over your Docker socket to restrict which requests it accepts | 2,773 | +21 |
| [compose-lint](https://github.com/tmatens/compose-lint) | Security-focused linter for Docker Compose files. Catches dangerous misconfigurations before they reach production. Grou | 56 | +4 |
| [buildcage](https://github.com/dash14/buildcage) | GitHub Action to build Docker images with outbound network access restricted to an allowlist | 11 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [cosign](../r/sigstore~cosign.md) | Code signing and transparency for containers and binaries | 6,304 | +18 |
| [in-toto](../r/in-toto~in-toto.md) | in-toto is a framework to protect supply chain integrity. | 1,039 | +2 |
...
| [witness](../r/in-toto~witness.md) | Witness is a pluggable framework for software supply chain risk management.  It automates, normalizes, and verifies soft | 545 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [DockTUI](https://github.com/strmax195-hue/docktui) | A lightweight, zero-dependency TUI dashboard for managing Docker containers and images dynamically in the terminal. | 35 | +1 |
| [dockup](https://github.com/paulo-amaral/dockup) | dockup - interactive TUI to install, harden and maintain Docker Engine, Compose v2, NVIDIA Container Toolkit and Apple c | 4 | +1 |
| [bosun](https://github.com/psychedelicdevx/bosun) | A fast terminal UI for Docker and Podman. Containers, images, volumes, networks, compose stacks, live logs and stats, lo | 4 |  |
| [layerx](../r/deveshctl~layerx.md) | LayerX Image Inspector - open-source terminal explorer for container images. Browse layers, spot wasted bytes, and gate  | 132 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Arcane](../r/getarcaneapp~arcane.md) | Modern Docker Management, Designed for Everyone | 7,412 | +85 |
...
| [tdocker](https://github.com/pivovarit/tdocker) | minimalistic terminal UI for everyday Docker operations | 89 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Label Backup](https://github.com/resulgg/label-backup) | Docker-aware backup agent using labels to automate backups for PostgreSQL, MySQL, MongoDB, and Redis to local or S3 comp | 24 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Docker Commander](https://github.com/koduj-dev/docker-commander) | Self-hosted Docker monitoring & control panel — a single Go binary with an embedded React UI. Multi-host, live logs & st | 3 |  |
| [DockScope](../r/manuelr-t~dockscope.md) | Visual Docker dashboard with a 3D dependency graph, live metrics, logs, terminal, and container actions | 109 |  |
...
| [Docker Curriculum](../r/prakhar1989~docker-curriculum.md) | 🐬 A comprehensive tutorial on getting started with Docker! | 6,094 | +5 |
| [wsargent](https://github.com/wsargent/docker-cheat-sheet) | Docker Cheat Sheet | 22,544 | +3 |
...
---
*Updated: 2026-09-17 | [View live site ↗](https://patrickclery.com/awesomer/l/docker/)*
