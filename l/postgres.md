...
|---|------|-------|----|-----|-----|
| 1 | [pgBoss](../r/timgit~pg-boss.md) | 3,995 | +34 | +103 | +308 |
| 2 | [CloudNativePG operator](../r/cloudnative-pg~cloudnative-pg.md) | 9,357 | +32 | +157 | +488 |
| 3 | [AGE](../r/apache~age.md) | 4,852 | +24 | +71 | +223 |
| 4 | [Teable](../r/teableio~teable.md) | 21,827 | +24 | +116 | +443 |
| 5 | [river](../r/riverqueue~river.md) | 5,711 | +24 | +106 | +430 |
| 6 | [pg_search](../r/paradedb~paradedb.md) | 9,308 | +23 | +117 | +345 |
| 7 | [atlas](../r/ariga~atlas.md) | 8,749 | +18 | +73 | +229 |
| 8 | [autobase](../r/vitabaks~autobase.md) | 4,402 | +14 | +56 | +119 |
| 9 | [Patroni](../r/zalando~patroni.md) | 8,745 | +14 | +63 | +194 |
| 10 | [coroot](../r/coroot~coroot.md) | 7,937 | +14 | +50 | +162 |
...
|------|-------------|-------|----|
| [wal-g](../r/wal-g~wal-g.md) | Archival and Restoration for databases in the Cloud | 4,257 | +8 |
| [pgbackweb](../r/eduardolat~pgbackweb.md) | 🐘 Effortless PostgreSQL backups with a user-friendly web interface! 🌐💾 | 2,636 | +3 |
| [pghoard](../r/aiven~pghoard.md) | PostgreSQL® backup and restore service | 1,423 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [atlas](../r/ariga~atlas.md) | Declarative schema migrations with schema-as-code workflows | 8,749 | +18 |
| [pgcli](../r/dbcli~pgcli.md) | Postgres CLI with autocompletion and syntax highlighting | 13,405 | +10 |
| [schemaspy](../r/schemaspy~schemaspy.md) | Database documentation built easy | 3,729 | +5 |
...
| [pg-schema-diff](../r/stripe~pg-schema-diff.md) | Go library for diffing Postgres schemas and generating SQL migrations | 887 | +3 |
| [sabiql](../r/riii111~sabiql.md) | Fast, safe-by-design, Vim-first TUI for PostgreSQL, MySQL, and SQLite, built in Rust. | 310 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Pigsty](../r/vonng~pigsty.md) | Enterprise-Grade OSS PostgreSQL Distribution with HA, PITR, IaC, Monitor, 12 kernel forks and 575 PG extensions. Best-of | 5,668 | +9 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [AGE](../r/apache~age.md) | Graph database optimized for fast analysis and real-time data processing. It is provided as an extension to PostgreSQL. | 4,852 | +24 |
| [pg_search](../r/paradedb~paradedb.md) | One Postgres for your application data, full-text search, vector retrieval, and aggregations. Home of the pg_search exte | 9,308 | +23 |
| [Citus](../r/citusdata~citus.md) | Distributed PostgreSQL as an extension | 12,786 | +8 |
| [pg_cron](../r/citusdata~pg_cron.md) | Run periodic jobs in PostgreSQL | 3,900 | +8 |
| [HypoPG](../r/hypopg~hypopg.md) | Hypothetical Indexes for PostgreSQL | 1,717 | +2 |
| [psql_bm25s](../r/intelligent-internet~psql_bm25s.md) | The fastest PostgreSQL BM25 engine, now support Sparse Semantic Retrieval in the same index. | 148 | +2 |
| [pg\_partman](../r/pgpartman~pg_partman.md) | Partition management extension for PostgreSQL | 2,825 | +1 |
| [pg\_squeeze](../r/cybertec-postgresql~pg_squeeze.md) | A PostgreSQL extension for automatic bloat cleanup | 699 | +1 |
...
| [pgRouting](../r/pgrouting~pgrouting.md) | Repository contains pgRouting library. Development branch is "develop", stable branch is "master" | 1,435 | +1 |
| [cstore\_fdw](https://github.com/citusdata/cstore_fdw) | Columnar storage extension for Postgres built as a foreign data wrapper. Check out https://github.com/citusdata/citus fo | 1,782 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Teable](../r/teableio~teable.md) | ✨ AI Spreadsheet for Business | 21,827 | +24 |
| [Redash](../r/getredash~redash.md) | Make Your Company Data Driven. Connect to any data source, easily visualize, dashboard and share your data. | 28,812 | +10 |
| [pgweb](../r/sosedoff~pgweb.md) | Cross-platform client for PostgreSQL databases | 9,515 | +6 |
| [Dekart](../r/dekart-xyz~dekart.md) | Open-source backend for Kepler.gl. Self-hosted alternative to CARTO and Foursquare Studio. | 422 | +4 |
| [temBoard](../r/dalibo~temboard.md) | PostgreSQL Remote Control | 771 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [autobase](../r/vitabaks~autobase.md) | Automated database platform for PostgreSQL® - Your own DBaaS. | 4,402 | +14 |
| [Patroni](../r/zalando~patroni.md) | A template for PostgreSQL High Availability with Etcd, Consul, ZooKeeper, or Kubernetes | 8,745 | +14 |
| [repmgr](../r/2ndquadrant~repmgr.md) | A lightweight replication manager for PostgreSQL (Postgres) | 1,714 | +1 |
| [Spock](../r/pgedge~spock.md) | Logical multi-master PostgreSQL replication | 752 | +1 |
...
| [pg_auto_failover](../r/citusdata~pg_auto_failover.md) | Postgres extension and service for automated failover and high-availability | 1,391 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [CloudNativePG operator](../r/cloudnative-pg~cloudnative-pg.md) | The most popular Kubernetes Operator for PostgreSQL. | 9,357 | +32 |
| [Zalando Operator](../r/zalando~postgres-operator.md) | Postgres operator creates and manages PostgreSQL clusters running in Kubernetes | 5,250 | +6 |
| [Crunchy Operator](../r/crunchydata~postgres-operator.md) | Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service. | 4,453 | +2 |
| [StackGres Operator](../r/ongres~stackgres.md) | StackGres Operator, Full Stack PostgreSQL on Kubernetes // !! Mirror repository of https://gitlab.com/ongresinc/stackgre | 1,429 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [node-postgres](../r/brianc~node-postgres.md) | PostgreSQL client for node.js. | 13,214 | +5 |
| [pg.zig](../r/karlseguin~pg.zig.md) | Native PostgreSQL driver / client for Zig | 602 | +5 |
| [pq](../r/lib~pq.md) | Go PostgreSQL driver for database/sql | 9,960 | +4 |
| [Npgsql](../r/npgsql~npgsql.md) | Npgsql is the .NET data provider for PostgreSQL. | 3,733 | +2 |
| [RPostgres](../r/r-dbi~rpostgres.md) | A DBI-compliant interface to PostgreSQL | 344 | +1 |
| [rust-postgresql](../r/sfackler~rust-postgres.md) | Native PostgreSQL driver for the Rust programming language | 4,001 | +1 |
...
| [postgrex](../r/elixir-ecto~postgrex.md) | PostgreSQL driver for Elixir | 1,217 | +0 |
| [Postmodern](https://github.com/marijnh/Postmodern) | A Common Lisp PostgreSQL programming interface | 431 | +0 |
| [zapatos](https://github.com/jawj/zapatos) | Zero-abstraction Postgres for TypeScript: a non-ORM database library | 1,402 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [coroot](../r/coroot~coroot.md) | Coroot is an open-source observability and APM tool with AI-powered Root Cause Analysis. It combines metrics, logs, trac | 7,937 | +14 |
| [postgres_exporter](../r/wrouesnel~postgres_exporter.md) | A PostgreSQL metric exporter for Prometheus | 3,622 | +5 |
| [pg_exporter](../r/vonng~pg_exporter.md) | Advanced PostgreSQL & Pgbouncer Metrics Exporter for Prometheus | 365 | +2 |
| [PMM](../r/percona~pmm.md) | Percona Monitoring and Management: an open source database monitoring, observability and management tool | 1,108 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [pgassistant](https://github.com/beh74/pgassistant-community) | A PostgreSQL assistant for developers Understand, optimize, and improve your PostgreSQL database with ease. | 53 | +5 |
| [PgHero](../r/ankane~pghero.md) | A performance dashboard for Postgres | 8,933 | +4 |
| [PEV2](../r/dalibo~pev2.md) | Postgres Explain Visualizer 2 | 3,599 | +1 |
| [pgtune](../r/le0pard~pgtune.md) | Pgtune - tuning PostgreSQL config by your hardware | 2,743 | +1 |
| [TimescaleDB Tune](../r/timescale~timescaledb-tune.md) | A tool for tuning TimescaleDB for better performance by adjusting settings to match your system's CPU and memory resourc | 506 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [neond](../r/matisiekpl~neond.md) | DX-focused control plane for Postgres dedicated to non-critical workloads. Your postgres:latest replacement 🐘  | 134 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Acra](../r/cossacklabs~acra.md) | Database security suite. Database proxy with field-level encryption, search through encrypted data, SQL injections preve | 1,493 | +1 |
| [pgrls](https://github.com/pgrls/pgrls) | Static analyzer for Postgres Row-Level Security — 67 lint rules covering tenant and per-user row-scoping bugs, performan | 27 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Apache Cloudberry](../r/apache~cloudberry.md) | One advanced and mature open-source MPP (Massively Parallel Processing) database. Open source alternative to Greenplum D | 1,415 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [pg-utils](../r/dataegret~pg-utils.md) | Useful PostgreSQL utilities | 1,219 | +1 |
| [SQL Syntax Cheat Sheet](https://github.com/mergisi/sql-syntax-cheat-sheet) | A comprehensive SQL syntax cheat sheet for quick reference, covering essential commands, functions, operators, and conce | 55 | +1 |
| [pagila](https://github.com/xzilla/pagila) | The PostgreSQL Sample Database | 79 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [pgloader](../r/dimitri~pgloader.md) | Migrate to PostgreSQL in a single command! | 6,539 | +9 |
| [PostgREST](../r/postgrest~postgrest.md) | REST API for any Postgres database | 27,680 | +8 |
| [pgroll](../r/xataio~pgroll.md) | PostgreSQL zero-downtime migrations made easy | 6,589 | +7 |
| [pgbadger](../r/darold~pgbadger.md) | A fast PostgreSQL Log Analyzer | 4,066 | +6 |
| [Hasura GraphQL Engine](../r/hasura~graphql-engine.md) | Blazing fast, instant realtime GraphQL APIs on all your data with fine grained access control, also trigger webhooks on  | 32,121 | +5 |
| [sqitch](../r/sqitchers~sqitch.md) | Sensible database change management | 3,167 | +5 |
| [Greenmask](../r/greenmaskio~greenmask.md) | Database anonymization and test data management | 1,769 | +4 |
| [pgCenter](../r/lesovsky~pgcenter.md) | Command-line admin tool for observing and troubleshooting Postgres. | 1,630 | +3 |
| [sqlcheck](https://github.com/jarulraj/sqlcheck) | Automatically identify anti-patterns in SQL queries | 2,525 | +3 |
| [pg_timetable](../r/cybertec-postgresql~pg_timetable.md) | pg_timetable: Advanced scheduling for PostgreSQL | 1,402 | +2 |
| [pg\_activity](../r/dalibo~pg_activity.md) | pg_activity is a top like application for PostgreSQL server activity monitoring. | 3,040 | +2 |
| [pgsync](../r/ankane~pgsync.md) | Sync data from one Postgres database to another | 3,476 | +2 |
| [PostGraphile](../r/graphile~postgraphile.md) | 🔮 Graphile's Crystal Monorepo; home to Grafast, PostGraphile, pg-introspection, pg-sql2 and much more! | 12,935 | +2 |
| [bemi](../r/bemihq~bemi.md) | Automatic data change tracking for PostgreSQL | 402 | +1 |
| [pg_chameleon](../r/the4thdoctor~pg_chameleon.md) | MySQL to PostgreSQL replica system | 442 | +1 |
| [pgspot](../r/timescale~pgspot.md) | Spot vulnerabilities in postgres SQL scripts | 149 | +1 |
...
| [ERAlchemy](../r/alexis-benoist~eralchemy.md) | Entity Relation Diagrams generation tool | 1,431 | +0 |
...
| [pREST](../r/prest~prest.md) | PostgreSQL ➕ REST, low-code, simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres  | 4,618 | +0 |
...
| [yoke](https://github.com/nanopack/yoke) | Postgres high-availability cluster with auto-failover and automated cluster recovery. | 1,339 | +0 |
| [ZSON](https://github.com/postgrespro/zson) | ZSON is a PostgreSQL extension for transparent JSONB compression | 569 | +0 |
| [migra](https://github.com/djrobstep/migra) | DEPRECATED: Like diff but for PostgreSQL schemas | 3,047 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [pgBoss](../r/timgit~pg-boss.md) | Queueing jobs in Postgres from Node.js like a boss | 3,995 | +34 |
| [river](../r/riverqueue~river.md) | Fast and reliable background jobs in Go | 5,711 | +24 |
| [pgmq](../r/pgmq~pgmq.md) | A lightweight message queue. Like AWS SQS and RSMQ but on Postgres. | 5,296 | +11 |
...
---
*Updated: 2026-09-26 | [View live site ↗](https://patrickclery.com/awesomer/l/postgres/)*
