...
|---|------|-------|----|-----|-----|
| 1 | [OpenCode](../r/anomalyco~opencode.md) | 207,534 | +2,529 | +9,592 | +32,027 |
| 2 | [yt-dlp](../r/yt-dlp~yt-dlp.md) | 191,302 | +1,546 | +6,558 | +20,195 |
| 3 | [ripgrep](../r/burntsushi~ripgrep.md) | 68,283 | +218 | +963 | +3,117 |
| 4 | [croc](../r/schollz~croc.md) | 40,337 | +216 | +527 | +5,058 |
| 5 | [yazi](../r/sxyazi~yazi.md) | 42,197 | +201 | +824 | +2,707 |
| 6 | [Lazygit](../r/jesseduffield~lazygit.md) | 82,353 | +195 | +990 | +2,984 |
| 7 | [rclone](../r/ncw~rclone.md) | 59,763 | +151 | +585 | +1,862 |
| 8 | [starship](../r/starship~starship.md) | 59,902 | +130 | +483 | +1,572 |
| 9 | [zoxide](../r/ajeetdsouza~zoxide.md) | 39,477 | +125 | +810 | +1,989 |
| 10 | [just](../r/casey~just.md) | 35,801 | +122 | +494 | +1,476 |
...
| [lean-ctx](../r/yvgude~lean-ctx.md) | LeanCTX — Context Intelligence for AI systems. | 3,787 | +58 |
| [agent-deck](../r/asheshgoplani~agent-deck.md) | Terminal session manager for AI coding agents. One TUI for Claude, Gemini, OpenCode, Codex, and more. | 894 | +46 |
| [agent-of-empires](../r/njbrake~agent-of-empires.md) | Manage multiple Claude Code, OpenCode agents from either TUI or Web for easy access on mobile. Also supports Mistral Vib | 3,245 | +36 |
...
| [Nanocoder](../r/nano-collective~nanocoder.md) | An open coding agent for your terminal, built by a community collective rather than a company. Bring your own model, kee | 2,475 | +9 |
| [hcom](../r/aannoo~hcom.md) | Let AI agents message, watch, and spawn each other across terminals. Claude Code, Codex, Antigravity CLI, Cursor CLI, Op | 496 | +7 |
...
| [AgentBridge](../r/raysonmeng~agent-bridge.md) | A local bridge for bidirectional collaboration between Claude Code and Codex. 连接 Claude Code 与 Codex 的本地实时协作桥接工具。 | 342 |  |
...
| [Keen Code](https://github.com/mochow13/keen-code) | A context-aware terminal-based coding agent written in Go. Supports multiple-providers, MCPs, Subagents, Agent Skills, c | 63 |  |
...
| [agentty](../r/1ay1~agentty.md) | AI pair programming in your terminal — one static binary, sub-ms startup, any model | 601 | -9 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Plakar](../r/plakarkorp~plakar.md) | plakar is a backup solution powered by Kloset and ptar | 2,057 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [concord](../r/chojs23~concord.md) | A feature-rich TUI client for Discord | 1,498 | +40 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [tldr](../r/tldr-pages~tldr.md) | Collaborative cheatsheets for console commands 📚. | 63,710 | +62 |
| [The Fuck](https://github.com/nvbn/thefuck) | Magnificent app which corrects your previous console command. | 97,848 | +32 |
...
| [config-file-validator](../r/boeing~config-file-validator.md) | Cross-platform CLI tool to validate configuration files across 18 formats. Syntax and schema validation with JSON Schema | 516 | +2 |
| [gron](https://github.com/tomnomnom/gron) | Make JSON greppable! | 14,517 | +1 |
...
| [rdsai-cli](https://github.com/aliyun/rdsai-cli) | RDSAI CLI is a next-generation, AI-powered RDS CLI that transforms how you interact with the databasea | 62 | +0 |
...
| [neovim](../r/neovim~neovim.md) | Vim-fork focused on extensibility and usability | 102,344 | +108 |
| [lazydocker](../r/jesseduffield~lazydocker.md) | The lazier way to manage everything docker | 52,831 | +79 |
| [helix](../r/helix-editor~helix.md) | A post-modern modal text editor. | 46,230 | +62 |
| [micro](../r/zyedidia~micro.md) | A modern and intuitive terminal-based text editor | 29,588 | +62 |
| [k9s](../r/derailed~k9s.md) | 🐶 Kubernetes CLI To Manage Your Clusters In Style! | 34,587 | +46 |
| [vim](../r/vim~vim.md) | The official Vim repository | 40,890 | +33 |
...
| [semantic-release](../r/semantic-release~semantic-release.md) | 📦🚀 Fully automated version management and package publishing | 24,037 | +16 |
| [cookiecutter](../r/audreyr~cookiecutter.md) | A cross-platform command-line utility that creates projects from cookiecutters (project templates), e.g. Python package  | 25,088 | +12 |
...
| [bats-core](../r/bats-core~bats-core.md) | Bash Automated Testing System | 6,260 | +10 |
| [logdy](https://github.com/logdyhq/logdy-core) | Realtime log viewer with web UI, tail -f for logs with a web interface browser. | 2,289 | +8 |
...
| [ATAC](../r/julien-cpsn~atac.md) | A simple API client (postman like) in your terminal | 3,726 | +6 |
| [mycli](../r/dbcli~mycli.md) | Rich MySQL Terminal Client with AutoCompletion, Syntax Highlighting, and Dataframes | 11,975 | +6 |
| [release-it](../r/webpro~release-it.md) | 🚀 Automate versioning and package publishing | 9,055 | +6 |
| [emacs](../r/emacs-mirror~emacs.md) | Mirror of GNU Emacs | 5,199 | +5 |
...
| [s3cmd](../r/s3tools~s3cmd.md) | Official s3cmd repo -- Command line tool for managing S3 compatible storage services (including Amazon S3 and CloudFront | 4,907 | +5 |
...
| [grex](../r/pemistahl~grex.md) | A command-line tool and Rust library with Python bindings for generating regular expressions from user-provided test cas | 8,185 | +3 |
| [npm-check-updates](../r/tjunnone~npm-check-updates.md) | Find newer versions of package dependencies than what your package.json allows | 10,316 | +3 |
...
| [curlie](../r/rs~curlie.md) | The power of curl, the ease of use of httpie. | 3,719 | +2 |
...
| [deviceframe](https://github.com/c0bra/deviceframe) | 📱 Put device frames around your mobile/web/progressive app screenshots. | 595 | +0 |
...
| [gdb-dashboard](../r/cyrus-and~gdb-dashboard.md) | Modular visual interface for GDB in Python | 12,249 | +0 |
...
| [Step CI](https://github.com/stepci/stepci) | Automated API Testing and Quality Assurance | 1,870 | +0 |
...
| [ctop](https://github.com/bcicen/ctop) | Top-like interface for container metrics | 17,838 | -1 |
...
| [kool](../r/kool-dev~kool.md) | From local development to the cloud: web apps development with containers made easy. | 723 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [mail-duplicate](../r/kdeldycke~mail-deduplicate.md) | 📧 CLI to deduplicate mails from mail boxes | 201 | +2 |
...
| [youtube-dl](../r/ytdl-org~youtube-dl.md) | Command-line program to download videos from YouTube.com and other video sites | 141,233 | +48 |
| [spotatui](../r/largemodgames~spotatui.md) | A fast, standalone terminal music player in Rust: native Spotify streaming plus local, Subsonic, radio, Qobuz and Youtub | 1,351 | +27 |
| [beets](../r/beetbox~beets.md) | music library manager and MusicBrainz tagger | 15,664 | +24 |
| [streamlink](../r/streamlink~streamlink.md) | Streamlink is a CLI utility which pipes video streams from various services into a video player | 11,756 | +15 |
| [mpd](../r/musicplayerdaemon~mpd.md) | Music Player Daemon | 2,771 | +11 |
...
| [hygg](../r/kruserr~hygg.md) | 📚 Simplifying the way you read. Minimalistic Vim-like TUI document reader. | 354 | +2 |
...
| [newsboat](../r/newsboat~newsboat.md) | An RSS/Atom feed reader for text terminals | 3,908 | +2 |
| [Pokete](../r/lxgr-linux~pokete.md) | A terminal based Pokemon like game | 3,155 | +2 |
...
| [TUISIC](https://github.com/Dark-Kernel/tuisic) | First of its kind, A simple TUI online music streaming application written in c++ with easy vim motions, now with suppor | 72 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [elio](../r/elio-fm~elio.md) | Snappy, batteries-included terminal file manager with rich previews, inline images, bulk actions, and trash support | 861 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [croc](../r/schollz~croc.md) | Easily and securely send things from one computer to another 🐊 📦 | 40,337 | +216 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ripgrep](../r/burntsushi~ripgrep.md) | ripgrep recursively searches directories for a regex pattern while respecting your gitignore | 68,283 | +218 |
| [yazi](../r/sxyazi~yazi.md) | 💥 Blazing fast terminal file manager written in Rust, based on async I/O. | 42,197 | +201 |
| [rclone](../r/ncw~rclone.md) | "rsync for cloud storage" - Google Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Wasabi, Google Cloud Stora | 59,763 | +151 |
...
| [ast-grep](../r/ast-grep~ast-grep.md) | ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust | 15,907 | +72 |
| [eza](../r/eza-community~eza.md) | A modern alternative to ls | 23,277 | +70 |
| [bat](../r/sharkdp~bat.md) | A cat(1) clone with wings. | 60,457 | +47 |
| [dust](../r/bootandy~dust.md) | A more intuitive version of du in rust | 12,264 | +35 |
| [dua-cli](../r/byron~dua-cli.md) | View disk space usage and delete unwanted data, fast. | 6,263 | +28 |
| [television](../r/alexpasmantier~television.md) | A very fast, portable and hackable fuzzy finder. | 6,269 | +27 |
| [scc](../r/boyter~scc.md) | Sloc, Cloc and Code: scc is a very fast accurate code counter with complexity calculations and COCOMO estimates written  | 8,750 | +24 |
...
| [duf](../r/muesli~duf.md) | Disk Usage/Free Utility - a better 'df' alternative | 15,300 | +11 |
...
| [midnight-commander](../r/midnightcommander~mc.md) | Midnight Commander's repository | 979 | +6 |
| [skim](../r/lotabout~skim.md) | Fuzzy Finder in rust! | 6,956 | +6 |
...
| [portal](https://github.com/ZinoKader/portal) | Portal is a quick and easy command-line file transfer utility from any computer to another 🌌 ✨ | 1,767 | +3 |
| [diskonaut](https://github.com/imsnif/diskonaut) | Terminal disk space navigator 🔭 | 3,128 | +2 |
...
| [tre](https://github.com/dduan/tre) | Tree command, improved. | 1,224 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [lakshmi](../r/sarvjeets~lakshmi.md) | Investing library and command-line interface inspired by the Bogleheads philosophy | 148 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gitfetch](../r/matars~gitfetch.md) | A neofetch alternative for GitHub quick view | 394 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [pastel](../r/sharkdp~pastel.md) | A command-line tool to generate, analyze, convert and manipulate colors | 6,491 | +8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gowall](../r/achno~gowall.md) | A tool to convert a Wallpaper's color scheme / palette, OCR with VLM's Traditional & Hybrid, Image Compression ,color pa | 2,310 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [asciinema](../r/asciinema~asciinema.md) | Terminal session recorder, streamer and player 📹 | 17,803 | +31 |
| [SVGO](../r/svg~svgo.md) | SVG Optimizer for Node.js and CLI. ⚙️ | 22,671 | +16 |
| [gifsicle](../r/kohler~gifsicle.md) | Create, manipulate, and optimize GIF images and animations | 4,318 | +5 |
...
| [rclip](../r/yurijmikhalevich~rclip.md) | grep for images – local, offline image search for the terminal | 1,001 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [terminaltexteffects](../r/chrisbuilds~terminaltexteffects.md) | TerminalTextEffects (TTE) is a terminal visual effects engine, application, and Python library. | 4,245 | +14 |
...
| [ponysay](https://github.com/erkin/ponysay) | Pony rewrite of cowsay. | 1,320 | +1 |
...
| [lolcat](https://github.com/busyloop/lolcat) | Rainbows and unicorns! | 6,579 | -1 |
...
| [mcat](../r/skardyy~mcat.md) | Terminal image, video, PDF, and Markdown viewer | 1,410 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [numr](../r/nasedkinpv~numr.md) | Natural-language text calculator with TUI/CLI: variables, units, currencies, and live exchange rates | 266 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ytm-player](../r/peternaame-boop~ytm-player.md) | YouTube Music TUI client with vim keybindings, synced lyrics, and cross-platform media keys | 507 | +11 |
| [termusic](../r/tramhao~termusic.md) | Music Player TUI written in Rust | 2,205 | +8 |
| [cliamp](../r/bjarneo~cliamp.md) | cliamp - Terminal music player inspired by winamp  | 4,180 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [tldx](../r/brandonyoungdev~tldx.md) | Bulk domain availability checking via RDAP, DNS, and WHOIS, with prefix/suffix permutations, regex patterns, MCP, and mu | 1,920 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [notesmd-cli](../r/yakitrak~notesmd-cli.md) | Obsidian CLI (Community) -  Interact with Obsidian in the terminal! | 1,584 | +8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-cli-apps-in-a-csv](../r/toolleeo~awesome-cli-apps-in-a-csv.md) | The largest Awesome Curated list of command line programs (CLI/TUI) with source data organized into CSV files | 2,616 | +10 |
| [x-cmd](../r/x-cmd~x-cmd.md) | Shell Superpowers for AI Agents. | 4,654 | +7 |
| [awesome-git-addons](https://github.com/stevemao/awesome-git-addons) | 😎 A curated list of add-ons that extend/enhance the git CLI. | 2,198 | +5 |
...
| [marp](../r/marp-team~marp-cli.md) | A CLI interface for Marp and Marpit based converters | 3,819 | +14 |
| [nb](../r/xwmx~nb.md) | CLI and local web plain text note‑taking, bookmarking, and archiving with linking, tagging, filtering, search, Git versi | 8,405 | +13 |
...
| [vdirsyncer](../r/pimutils~vdirsyncer.md) | 📇 Synchronize calendars and contacts. | 1,874 | +2 |
...
| [journalot](https://github.com/jtaylortech/journalot) | Minimal journaling CLI for developers. Git-backed, terminal-native, zero friction. Just type `journal` and start writing | 98 | +1 |
| [Timewarrior](../r/gothenburgbitfactory~timewarrior.md) | Timewarrior - Commandline Time Tracking and Reporting | 1,658 | +1 |
| [birthday](https://github.com/IonicaBizau/birthday) | 🎂 Know when a friend's birthday is coming. | 94 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [jiratui](../r/whyisdifficult~jiratui.md) | A Textual User Interface for interacting with Atlassian Jira from your shell | 1,697 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ytunnel](https://github.com/yetidevworks/ytunnel) | A TUI-first CLI for managing Cloudflare Tunnels with custom domains | 52 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gitlogue](../r/unhappychoice~gitlogue.md) | A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story. | 4,979 | +10 |
| [cmatrix](https://github.com/Treri/cmatrix) | Terminal based "The Matrix" like implementation | 5,244 | +5 |
...
| [pipes.sh](https://github.com/pipeseroni/pipes.sh) | Animated pipes terminal screensaver | 3,024 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [andcli](../r/tjblackheart~andcli.md) | A 2FA TUI for your shell | 157 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [upterm](../r/owenthereal~upterm.md) | Instant Terminal Sharing | 1,293 | +6 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Microsoft Edit](../r/microsoft~edit.md) | We all edit. | 14,570 | +26 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Tock](../r/kriuchkov~tock.md) | Tock is a powerful time tracking tool for the command line. It saves activity logs as plaintext files and provides an in | 478 | +6 |
...
| [Focusd](https://github.com/0xarchit/Focusd) | Free, open-source screen time tracker for Windows. Monitors app usage, tracks browser tabs, sets daily limits. No cloud, | 41 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gittype](../r/unhappychoice~gittype.md) | A CLI code-typing game that turns your source code into typing challenges | 1,599 | +12 |
| [amazon-orders](../r/alexdlaird~amazon-orders.md) | A Python library (and CLI) for Amazon order history, line items, and transactions | 177 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [starship](../r/starship~starship.md) | ☄🌌️  The minimal, blazing-fast, and infinitely customizable prompt for any shell! | 59,902 | +130 |
| [fastfetch](../r/fastfetch-cli~fastfetch.md) | A maintained, feature-rich and performance oriented, neofetch like system information tool. | 24,639 | +110 |
| [glow](../r/charmbracelet~glow.md) | Render markdown on the CLI, with pizzazz! 💅🏻 | 27,313 | +102 |
| [aria2](../r/tatsuhiro-t~aria2.md) | aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It suppo | 42,334 | +76 |
| [rustnet](../r/domcyrus~rustnet.md) | Per-process network monitoring for your terminal with deep packet inspection. Cross-platform, sandboxed. | 5,024 | +59 |
| [wttr.in](../r/chubin~wttr.in.md) | ⛅ The right way to check the weather | 30,535 | +42 |
| [bandwhich](../r/imsnif~bandwhich.md) | Terminal bandwidth utilization tool | 11,968 | +14 |
| [Clipboard](../r/slackadays~clipboard.md) | 😎🏖️🐬 Your new, 𝙧𝙞𝙙𝙤𝙣𝙠𝙪𝙡𝙞𝙘𝙞𝙤𝙪𝙨𝙡𝙮 smart clipboard manager | 5,900 | +13 |
| [gopass](../r/gopasspw~gopass.md) | The slightly more awesome standard unix password manager for teams | 7,148 | +11 |
| [Qalculate](../r/qalculate~libqalculate.md) | Qalculate! library and CLI | 2,664 | +9 |
| [sshuttle](../r/sshuttle~sshuttle.md) | Transparent proxy server that works as a poor man's VPN.  Forwards over ssh.  Doesn't require admin.  Works with Linux a | 13,561 | +8 |
| [intelli-shell](../r/lasantosr~intelli-shell.md) | Like IntelliSense, but for shells | 1,287 | +6 |
| [translate-shell](https://github.com/soimort/translate-shell) | 💬 Command-line translator using Google Translate, Bing Translator, Yandex.Translate, etc. | 7,508 | +6 |
...
| [mapscii](https://github.com/rastapasta/mapscii) | 🗺  MapSCII is a Braille & ASCII world map renderer for your console - enter => telnet mapscii.me <= on Mac (brew instal | 9,234 | +2 |
...
| [ots](https://github.com/sniptt-official/ots) | 🔐 Share end-to-end encrypted secrets with others via a one-time URL | 1,844 | +0 |
...
| [speedtest-cli](https://github.com/sivel/speedtest-cli) | Command line interface for testing internet bandwidth using speedtest.net | 14,063 | -6 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Lazygit](../r/jesseduffield~lazygit.md) | simple terminal UI for git commands | 82,353 | +195 |
| [gitui](../r/extrawurst~gitui.md) | Blazing 💥 fast terminal-ui for git written in rust 🦀 | 22,494 | +26 |
| [tig](../r/jonas~tig.md) | Text-mode interface for git | 13,336 | +12 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [capcut-cli](../r/renezander030~capcut-cli.md) | Independent, unofficial CLI to edit CapCut and JianYing (剪映) projects — subtitles, timing, speed, volume, templates, cut | 470 | +21 |
...
| [linecast](../r/ashuttl~linecast.md) | Weather, tides, the sun, the moon, maps, and a planetarium, in your terminal. The Old Farmer's Almanac meets Minitel. | 478 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Mole](../r/tw93~mole.md) | 🐹 Clean, uninstall, analyze, optimize, and monitor your Mac. Free open-source CLI, plus a native Mac app. | 67,247 |  |
| [Raccoon](../r/thousandflowers~raccoon.md) | macOS companion toolkit for power users | 130 |  |

[Back to top](#awesome-cli-apps)

---
*Updated: 2026-09-15 | [View live site ↗](https://patrickclery.com/awesomer/l/cli-apps/)*
