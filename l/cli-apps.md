...
|---|------|-------|----|-----|-----|
| 1 | [OpenCode](../r/anomalyco~opencode.md) | 206,936 | +2,529 | +10,049 | +32,742 |
| 2 | [yt-dlp](../r/yt-dlp~yt-dlp.md) | 190,663 | +1,546 | +6,473 | +20,171 |
| 3 | [ripgrep](../r/burntsushi~ripgrep.md) | 68,210 | +218 | +924 | +3,176 |
| 4 | [croc](../r/schollz~croc.md) | 40,310 | +216 | +599 | +5,050 |
| 5 | [yazi](../r/sxyazi~yazi.md) | 42,137 | +201 | +849 | +2,752 |
| 6 | [Lazygit](../r/jesseduffield~lazygit.md) | 82,279 | +195 | +998 | +3,024 |
| 7 | [rclone](../r/ncw~rclone.md) | 59,738 | +151 | +622 | +1,904 |
| 8 | [starship](../r/starship~starship.md) | 59,874 | +130 | +493 | +1,600 |
| 9 | [zoxide](../r/ajeetdsouza~zoxide.md) | 39,429 | +125 | +799 | +2,018 |
| 10 | [just](../r/casey~just.md) | 35,760 | +122 | +480 | +1,485 |
...
|------|-------------|-------|----|
| [OpenCode](../r/anomalyco~opencode.md) | The open source coding agent. | 206,936 | +2,529 |
| [lean-ctx](../r/yvgude~lean-ctx.md) | LeanCTX — Context Intelligence for AI systems. | 3,771 | +58 |
| [agent-deck](../r/asheshgoplani~agent-deck.md) | Terminal session manager for AI coding agents. One TUI for Claude, Gemini, OpenCode, Codex, and more. | 875 | +46 |
...
| [coi](../r/mensfeld~code-on-incus.md) | Give each AI agent its own isolated machine with root, Docker, and systemd. Active defense detects and stops threats aut | 701 | +10 |
...
| [hcom](../r/aannoo~hcom.md) | Let AI agents message, watch, and spawn each other across terminals. Claude Code, Codex, Antigravity CLI, Cursor CLI, Op | 488 | +7 |
| [bosun](../r/yetidevworks~bosun.md) | Tmux-native orchestrator for AI agent sessions. Rust + ratatui. | 45 | +2 |
| [Shep](../r/shep-ai~cli.md) | Ship features 10x faster. Built In Auto: Memory, K8S Agent & Security (SDD+SDLC) . 😇 | 251 | +2 |
...
| [greywall](../r/greyhavenhq~greywall.md) | Container-free, deny-by-default sandbox for AI coding agents. Kernel-enforced filesystem, network, and syscall isolation | 295 | +1 |
| [toktrack](../r/mag123c~toktrack.md) | Ultra-fast token & cost tracker for LLM Token Usage (e.g. Claude Code) | 189 | +1 |
| [AgentBridge](../r/raysonmeng~agent-bridge.md) | A local bridge for bidirectional collaboration between Claude Code and Codex. 连接 Claude Code 与 Codex 的本地实时协作桥接工具。 | 339 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Plakar](../r/plakarkorp~plakar.md) | plakar is a backup solution powered by Kloset and ptar | 2,052 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [concord](../r/chojs23~concord.md) | A feature-rich TUI client for Discord | 1,480 | +40 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [tldr](../r/tldr-pages~tldr.md) | Collaborative cheatsheets for console commands 📚. | 63,692 | +62 |
| [The Fuck](../r/nvbn~thefuck.md) | Magnificent app which corrects your previous console command. | 97,844 | +32 |
...
| [dyff](../r/homeport~dyff.md) | /ˈdʏf/ - diff tool for YAML files, and sometimes JSON | 1,884 | +4 |
| [stegcloak](../r/kurolabs~stegcloak.md) | Hide secrets with invisible characters in plain text securely using passwords 🧙🏻‍♂️⭐ | 3,889 | +4 |
...
| [config-file-validator](../r/boeing~config-file-validator.md) | Cross-platform CLI tool to validate configuration files across 18 formats. Syntax and schema validation with JSON Schema | 516 | +2 |
| [gron](../r/tomnomnom~gron.md) | Make JSON greppable! | 14,516 | +1 |
...
| [ramda-cli](../r/raine~ramda-cli.md) | 🐏 A CLI tool for processing data with functional pipelines | 581 | +0 |
...
| [nless](../r/mpryor~nothing-less.md) | A TUI pager with advanced support for tabular data, inferring/swapping delimiters, and real-time event parsing.  | 278 | +0 |
...
| [k9s](../r/derailed~k9s.md) | 🐶 Kubernetes CLI To Manage Your Clusters In Style! | 34,566 | +46 |
...
| [bats-core](../r/bats-core~bats-core.md) | Bash Automated Testing System | 6,258 | +10 |
...
| [ATAC](../r/julien-cpsn~atac.md) | A simple API client (postman like) in your terminal | 3,723 | +6 |
...
| [s3cmd](../r/s3tools~s3cmd.md) | Official s3cmd repo -- Command line tool for managing S3 compatible storage services (including Amazon S3 and CloudFront | 4,909 | +5 |
...
| [npm-check-updates](../r/tjunnone~npm-check-updates.md) | Find newer versions of package dependencies than what your package.json allows | 10,314 | +3 |
| [updatecli](../r/updatecli~updatecli.md) | A Declarative Update Policy Engine | 979 | +3 |
...
| [HTTP Prompt](../r/eliangcs~http-prompt.md) | An interactive command-line HTTP and API testing client built on top of HTTPie featuring autocomplete, syntax highlighti | 9,108 | +1 |
...
| [gdb-dashboard](../r/cyrus-and~gdb-dashboard.md) | Modular visual interface for GDB in Python | 12,248 | +0 |
...
| [ctop](../r/bcicen~ctop.md) | Top-like interface for container metrics | 17,836 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [bencher](../r/bencherdev~bencher.md) | 🐰 Bencher - Continuous Benchmarking | 898 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [darya](../r/mrkatebzadeh~darya.md) | Disk usage explorer with a TUI and live treemap | 151 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [golazo](../r/0xjuanma~golazo.md) | The beautiful game in your terminal. Minimal TUI app to keep up with live & recent football/soccer matches written in Go | 859 | -1 |
...
| [youtube-dl](../r/ytdl-org~youtube-dl.md) | Command-line program to download videos from YouTube.com and other video sites | 141,199 | +48 |
| [spotatui](../r/largemodgames~spotatui.md) | A fast, standalone terminal music player in Rust: native Spotify streaming plus local, Subsonic, radio, Qobuz and Youtub | 1,336 | +27 |
...
| [musikcube](../r/clangen~musikcube.md) | a cross-platform, terminal-based music player, audio engine, metadata indexer, and server in c++ | 4,839 | +7 |
...
| [yazi](../r/sxyazi~yazi.md) | 💥 Blazing fast terminal file manager written in Rust, based on async I/O. | 42,137 | +201 |
...
| [ast-grep](../r/ast-grep~ast-grep.md) | ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust | 15,875 | +72 |
| [eza](../r/eza-community~eza.md) | A modern alternative to ls | 23,247 | +70 |
| [bat](../r/sharkdp~bat.md) | A cat(1) clone with wings. | 60,432 | +47 |
| [dust](../r/bootandy~dust.md) | A more intuitive version of du in rust | 12,254 | +35 |
| [dua-cli](../r/byron~dua-cli.md) | View disk space usage and delete unwanted data, fast. | 6,252 | +28 |
| [television](../r/alexpasmantier~television.md) | A very fast, portable and hackable fuzzy finder. | 6,261 | +27 |
| [scc](../r/boyter~scc.md) | Sloc, Cloc and Code: scc is a very fast accurate code counter with complexity calculations and COCOMO estimates written  | 8,740 | +24 |
...
| [entr](../r/eradman~entr.md) | Run arbitrary commands when files change | 5,680 | +8 |
| [midnight-commander](../r/midnightcommander~mc.md) | Midnight Commander's repository | 977 | +6 |
| [skim](../r/lotabout~skim.md) | Fuzzy Finder in rust! | 6,951 | +6 |
...
| [RecoverPy](../r/pablolec~recoverpy.md) | Interactively find and recover deleted or 👉 overwritten 👈 files from your terminal | 1,789 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [pastel](../r/sharkdp~pastel.md) | A command-line tool to generate, analyze, convert and manipulate colors | 6,489 | +8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gowall](../r/achno~gowall.md) | A tool to convert a Wallpaper's color scheme / palette, OCR with VLM's Traditional & Hybrid, Image Compression ,color pa | 2,313 | +2 |
...
| [SVGO](../r/svg~svgo.md) | SVG Optimizer for Node.js and CLI. ⚙️ | 22,668 | +16 |
| [gifsicle](../r/kohler~gifsicle.md) | Create, manipulate, and optimize GIF images and animations | 4,316 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [freeze](../r/charmbracelet~freeze.md) | Generate images of code and terminal output 📸 | 4,831 | +10 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [aye-chat](../r/acrotron~aye-chat.md) | Aye Chat: AI-powered terminal workspace | 63 | +0 |
...
| [Jimmy](../r/marph91~jimmy.md) | Convert your notes to Markdown | 528 | +1 |
| [mcat](../r/skardyy~mcat.md) | Terminal image, video, PDF, and Markdown viewer | 1,408 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ytm-player](../r/peternaame-boop~ytm-player.md) | YouTube Music TUI client with vim keybindings, synced lyrics, and cross-platform media keys | 503 | +11 |
| [termusic](../r/tramhao~termusic.md) | Music Player TUI written in Rust | 2,202 | +8 |
| [cliamp](../r/bjarneo~cliamp.md) | cliamp - Terminal music player inspired by winamp  | 4,116 |  |
| [tunein-cli](../r/tsirysndr~tunein-cli.md) | Browse and listen to thousands of radio stations across the globe right from your terminal 🌎 📻 🎵✨ | 108 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [confluence-cli](../r/pchuri~confluence-cli.md) | A powerful command-line interface for Atlassian Confluence | 287 | +7 |
| [epiq](../r/ljtn~epiq.md) | Distributed, code-native issue tracker - audit workflows via time-travel | 373 | +4 |
...
| [marp](../r/marp-team~marp-cli.md) | A CLI interface for Marp and Marpit based converters | 3,814 | +14 |
...
| [vdirsyncer](../r/pimutils~vdirsyncer.md) | 📇 Synchronize calendars and contacts. | 1,873 | +2 |
...
| [fjira](../r/mk-5~fjira.md) | The golang fuzzy-find cli jira interface 🚀 | 273 | +1 |
...
| [Timewarrior](../r/gothenburgbitfactory~timewarrior.md) | Timewarrior - Commandline Time Tracking and Reporting | 1,655 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [astroterm](../r/da-luce~astroterm.md) | A planetarium for your terminal! Explore stars, planets, constellations, and more, all rendered right in the command lin | 2,041 | +9 |
| [birda](../r/tphakala~birda.md) | Fast CLI tool for bird species detection using BirdNET and Perch AI models | 35 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gitlogue](../r/unhappychoice~gitlogue.md) | A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story. | 4,970 | +10 |
| [cmatrix](../r/treri~cmatrix.md) | Terminal based "The Matrix" like implementation | 5,240 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [starship](../r/starship~starship.md) | ☄🌌️  The minimal, blazing-fast, and infinitely customizable prompt for any shell! | 59,874 | +130 |
...
| [glow](../r/charmbracelet~glow.md) | Render markdown on the CLI, with pizzazz! 💅🏻 | 27,282 | +102 |
| [aria2](../r/tatsuhiro-t~aria2.md) | aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It suppo | 42,125 | +76 |
| [rustnet](../r/domcyrus~rustnet.md) | Per-process network monitoring for your terminal with deep packet inspection. Cross-platform, sandboxed. | 5,019 | +59 |
...
| [Qalculate](../r/qalculate~libqalculate.md) | Qalculate! library and CLI | 2,659 | +9 |
...
| [s](../r/zquestz~s.md) | Open a web search in your terminal. | 2,600 | +4 |
...
| [alex](../r/get-alex~alex.md) | Catch insensitive, inconsiderate writing | 5,098 | +2 |
...
| [yank](../r/mptre~yank.md) | Yank terminal output to clipboard | 1,712 | +1 |
...
| [gg](../r/mzz2017~gg.md) | 一个支持节点与订阅链接的 Linux 命令行代理工具 \| A command-line tool for one-click proxy in your research and development without installin | 1,932 | +0 |
| [gtree](../r/ddddddo~gtree.md) | Easily output ASCII tree from Go program or Markdown unordered list . There's also CLI tool that can output tree from JS | 360 | +0 |
...
| [ots](../r/sniptt-official~ots.md) | 🔐 Share end-to-end encrypted secrets with others via a one-time URL | 1,845 | +0 |
...
| [Ultimate Plumber](../r/akavel~up.md) | Ultimate Plumber is a tool for writing Linux pipes with instant live preview | 8,843 | -1 |
| [speedtest-cli](../r/sivel~speedtest-cli.md) | Command line interface for testing internet bandwidth using speedtest.net | 14,065 | -6 |
...
| [gitui](../r/extrawurst~gitui.md) | Blazing 💥 fast terminal-ui for git written in rust 🦀 | 22,479 | +26 |
| [tig](../r/jonas~tig.md) | Text-mode interface for git | 13,331 | +12 |
...
| [readme-md-generator](../r/kefranabg~readme-md-generator.md) | 📄 CLI that generates beautiful README.md files | 11,133 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [capcut-cli](../r/renezander030~capcut-cli.md) | Independent, unofficial CLI to edit CapCut and JianYing projects — subtitles, timing, speed, volume, templates, cut long | 457 | +21 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [weathr](../r/veirt~weathr.md) | a terminal weather app with ascii animation | 3,045 | +10 |
| [linecast](../r/ashuttl~linecast.md) | Weather, tides, the sun, the moon, and maps, in your terminal. The Old Farmer's Almanac meets Minitel. | 460 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Mole](../r/tw93~mole.md) | 🐹 Clean, uninstall, analyze, optimize, and monitor your Mac. Free open-source CLI, plus a native Mac app. | 66,934 |  |
| [Raccoon](../r/thousandflowers~raccoon.md) | macOS companion toolkit for power users | 130 |  |

[Back to top](#awesome-cli-apps)

---
*Updated: 2026-09-13 | [View live site ↗](https://patrickclery.com/awesomer/l/cli-apps/)*
