...
|---|------|-------|----|-----|-----|
| 1 | [iptv-org/iptv](../r/iptv-org~iptv.md) | 138,993 | +555 | +2,761 | +13,366 |
| 2 | [Sonarr](../r/sonarr~sonarr.md) | 16,364 | +471 | +1,187 | +2,370 |
| 3 | [jellyfin](../r/jellyfin~jellyfin.md) | 57,289 | +278 | +1,309 | +3,822 |
| 4 | [gallery-dl](../r/mikf~gallery-dl.md) | 19,754 | +267 | +491 | +1,167 |
| 5 | [uBlock Origin](../r/gorhill~ublock.md) | 67,963 | +175 | +822 | +2,359 |
| 6 | [trackerslist](../r/ngosang~trackerslist.md) | 55,154 | +54 | +243 | +950 |
| 7 | [Calibre-Web](../r/janeczku~calibre-web.md) | 18,212 | +40 | +213 | +689 |
| 8 | [Nebula](../r/slackhq~nebula.md) | 18,362 | +28 | +731 | +948 |
| 9 | [Jackett](../r/jackett~jackett.md) | 16,053 | +28 | +137 | +444 |
| 10 | [Beets](../r/beetbox~beets.md) | 15,677 | +26 | +114 | +390 |
...
|------|-------------|-------|----|
| [Yalp Store](https://github.com/yeriomin/YalpStore) | Download apks from Google Play Store | 2,547 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [AAXtoMP3](https://github.com/KrumpetPirate/AAXtoMP3) | Convert Audible's .aax filetype to MP3, FLAC, M4A, or OPUS | 1,288 | +1 |
...
| [traktarr](https://github.com/l3uddz/traktarr) | Script to add new series & movies to Sonarr/Radarr based on Trakt lists. | 623 | +0 |
...
| [Pulsarr](https://github.com/roboticsound/Pulsarr) |  | 204 | -1 |
...
| [Anti-Paywall](https://github.com/nextgens/anti-paywall) | A browser extension that maximizes the chances of bypassing paywalls | 690 | +1 |
| [Google Unlocked](https://github.com/Ibit-to/google-unlocked) | Google Unlocked browser extension uncensor google search results | 2,394 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [plexdrive](https://github.com/dweidenfeld/plexdrive) | Plexdrive mounts your Google Drive FUSE filesystem (optimized for media playback) | 1,770 | +0 |
| [UDS](https://github.com/stewartmcgown/uds) | 📀 Unlimited Google Drive Storage by splitting binary files into base64 | 4,376 | +0 |
| [google-drive-ocamlfuse](../r/astrada~google-drive-ocamlfuse.md) | FUSE filesystem over Google Drive | 5,959 | -3 |
...
| [popular-movies](../r/sjlu~popular-movies.md) | Tries to create a list of popular movies based on a series of heuristics | 430 | +0 |
...
| [udemy-downloader-gui](https://github.com/FaisalUmair/udemy-downloader-gui) | A desktop application for downloading Udemy Courses | 6,317 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [annie](../r/iawia002~annie.md) | 👾 Fast and simple video download library and CLI tool written in Go | 31,690 | +13 |
| [ripme](../r/ripmeapp~ripme.md) | Downloads albums from the web in bulk for archive purposes | 4,119 | +5 |
| [get_iplayer](https://github.com/get-iplayer/get_iplayer) | A utility for downloading TV and radio programmes from BBC iPlayer and BBC Sounds | 2,546 | +3 |
| [axel](../r/axel-download-accelerator~axel.md) | Lightweight CLI download accelerator | 3,401 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Heimdall](../r/linuxserver~heimdall.md) | An Application dashboard and launcher | 9,330 | +13 |
| [Organizr](../r/causefx~organizr.md) | HTPC/Homelab Services Organizer - Written in PHP | 5,815 | +1 |
...
| [HTPC-Manager](https://github.com/Hellowlol/HTPC-Manager) | A fully responsive interface to manage all your favorite software on your Htpc. | 343 | -1 |
| [Monitorr](https://github.com/Monitorr/Monitorr) | "Monitorr” is a self-hosted PHP web app that monitors the status of local and remote network services, websites, and app | 677 | -1 |
| [Muximux](../r/mescon~muximux.md) | A self-hosted homelab dashboard with an optional built-in reverse proxy that makes stubborn apps work in iframes | 1,214 | -2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Loki](../r/loki-project~loki-network.md) | Lokinet is an anonymous, decentralized and IP based overlay network for the internet. | 2,091 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [idm-trial-reset](https://github.com/J2TeaM/idm-trial-reset) | Use IDM forever without cracking | 4,146 | +7 |
| [Persepolis](../r/persepolisdm~persepolis.md) | Persepolis is a download manager written in Python. | 7,454 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Calibre-Web](../r/janeczku~calibre-web.md) | 📚 Web app for browsing, reading and downloading eBooks stored in a Calibre database | 18,212 | +40 |
| [DeDRM_tools](https://github.com/apprenticeharper/DeDRM_tools) | DeDRM tools for ebooks | 15,335 | +3 |
| [COPS](https://github.com/seblucas/cops) | Calibre OPDS (and HTML) PHP Server : web-based light alternative to Calibre content server / Calibre2OPDS to serve ebook | 1,488 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Beets](../r/beetbox~beets.md) | music library manager and MusicBrainz tagger | 15,677 | +26 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gallery-dl](../r/mikf~gallery-dl.md) | Command-line program to download image galleries and collections from several image hosting sites | 19,754 | +267 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Steamless](https://github.com/atom0s/Steamless) | Steamless is a DRM remover of the SteamStub variants.  The goal of Steamless is to make a single solution for unpacking  | 5,046 | +14 |
...
| [SmartSteamEmu](https://github.com/MAXBURAOT/SmartSteamEmu) | SSELauncher Comfy Edition 2018 By LoodBot/Syahmixp (Steam Emulator) | 430 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [iptv-org/iptv](../r/iptv-org~iptv.md) | Collection of publicly available IPTV channels from all over the world | 138,993 | +555 |
| [tvheadend](../r/tvheadend~tvheadend.md) | Tvheadend is the leading TV streaming server for Linux with ATSC, DVB-C/C2, DVB-S/S2, DVB-T/T2, IPTV, SAT>IP and unix pi | 3,521 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [weechat](../r/weechat~weechat.md) | The extensible chat client. | 3,391 | +7 |
| [KVIrc](../r/kvirc~kvirc.md) | The KVIrc IRC Client | 303 | -1 |
| [Shout](https://github.com/erming/shout) | Deprecated. See fork @ https://github.com/thelounge | 3,589 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [HakuNeko](../r/manga-download~hakuneko.md) | Manga & Anime Downloader for Linux, Windows & MacOS | 6,340 | +6 |
...
| [Gerbera](../r/gerbera~gerbera.md) | UPnP Media Server for 2026: Stream your digital media through your home network and consume it on all kinds of UPnP supp | 1,394 | +2 |
...
| [Streama](../r/streamaserver~streama.md) | Self hosted streaming media server. https://docs.streama-project.com/ | 9,819 | -3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [netflix-proxy](https://github.com/ab77/netflix-proxy) | Smart DNS proxy to watch Netflix | 3,739 | +2 |
| [PiracyArchive](https://github.com/nid666/PiracyArchive) | A complete backup of the Reddit r/Piracy sub | 464 | +2 |
...
| [castnow](https://github.com/xat/castnow) | commandline chromecast player | 3,813 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [AnYme](https://github.com/zunjae/anYme) | Unofficial Android Anime App for MyAnimeList | 1,150 | +1 |
...
| [CouchPotato](https://github.com/CouchPotato/CouchPotatoServer) | Automatic Movie Downloading via NZBs & Torrents | 3,869 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gonic](../r/sentriz~gonic.md) | music streaming server / free-software subsonic server API implementation | 2,548 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Lidarr](../r/lidarr~lidarr.md) | Looks and smells like Sonarr but made for music. | 5,663 | +15 |
| [betanin](../r/sentriz~betanin.md) | beets based mitm of your torrent client and music player | 459 | +0 |
| [Headphones](https://github.com/rembo10/headphones) | Automatic music downloader for SABnzbd | 3,757 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [OpenDirectoryDownloader](../r/koalabear84~opendirectorydownloader.md) | Indexes open directories | 1,390 | +3 |
| [andesite](https://github.com/nektro/andesite) | 💾 Easily manage access to your open directory through OAuth2 | 78 | +0 |
| [FileMasta](https://github.com/HerbL27/FileMasta) | A search application to explore, discover and share online files | 670 | +0 |
| [opendirectories-bot](https://github.com/simon987/opendirectories-bot) |  | 37 | +0 |
| [httpdirfs](../r/fangfufu~httpdirfs.md) | A filesystem which allows you to mount HTTP directory listings or a single file, with a permanent cache. Now with Airson | 885 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Keepass2Android](../r/philippc~keepass2android.md) | Password manager app for Android | 6,235 | +10 |
...
| [linuxserver/docker-plex](../r/linuxserver~docker-plex.md) |  | 1,438 | -1 |
...
| [plexWatch](https://github.com/ljunkie/plexWatch) | Notify and Log watched content on a Plex Media Server | 431 | -1 |
...
| [Plex-Trakt-Scrobbler](https://github.com/trakt/Plex-Trakt-Scrobbler) | Add what you are watching on Plex to trakt.tv | 1,459 | +1 |
...
| [ExportTools.bundle](https://github.com/ukdtom/ExportTools.bundle) | Export tools for Plex | 324 | -1 |
| [Sub-Zero.bundle](https://github.com/pannal/Sub-Zero.bundle) | Subtitles for Plex, as good you would expect them to be. | 1,751 | -1 |
...
| [Mellow](https://github.com/v0idp/Mellow) | Mellow can communicate with several APIs like Ombi, Sonarr, Radarr and Tautulli which are related to home streaming to u | 204 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [PlexMissingEpisodes](https://github.com/MysticRyuujin/PlexMissingEpisodes) | Scan Plex Library for Missing Episodes using TheTVDB | 57 | +1 |
...
| [JBOPS](../r/blacktwin~jbops.md) | Just a Bunch Of Plex Scripts | 1,925 | +0 |
...
| [plexupdate](https://github.com/mrworf/plexupdate) | Plex Update script to simplify the life of Linux Plex Media Server users. | 1,875 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [nvidia-patch](../r/keylase~nvidia-patch.md) |  This patch removes restriction on maximum number of simultaneous NVENC video encoding sessions imposed by Nvidia to con | 4,803 | +7 |
| [kube-plex](https://github.com/munnerz/kube-plex) | Scalable Plex Media Server on Kubernetes -- dispatch transcode jobs as pods on your cluster! | 1,244 | +0 |
...
| [WarezBot](https://github.com/enzobes/WarezBot) | Public Version of Discord bot for scene release | 46 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Any Soft Keyboard](../r/anysoftkeyboard~anysoftkeyboard.md) | Android on screen keyboard for multiple languages and NO internet access | 3,377 | +4 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Nebula](../r/slackhq~nebula.md) | A scalable overlay networking tool with a focus on performance, simplicity and security | 18,362 | +28 |
| [sshuttle](../r/sshuttle~sshuttle.md) | Transparent proxy server that works as a poor man's VPN.  Forwards over ssh.  Doesn't require admin.  Works with Linux a | 13,567 | +14 |
| [n2n](../r/ntop~n2n.md) | Peer-to-peer VPN | 7,016 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Downtify](https://github.com/eviabs/downtify-premium) | Downtify is an open source Spofity downloader which makes it possible to download all your favourite songs and/or playli | 406 | +1 |
| [EZBlocker](https://github.com/Xeroday/Spotify-Ad-Blocker) | EZBlocker - A Spotify Ad Blocker for Windows | 1,846 | +0 |
| [BlockTheSpot](../r/mrpond~blockthespot.md) | Video, audio & banner adblock/skip for Spotify | 12,476 | -9 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [sync](../r/calzoneman~sync.md) | Node.JS Server and JavaScript/HTML Client for synchronizing online media | 1,588 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [PimpMyStremio](https://github.com/sungshon/PimpMyStremio) | Local add-on manager for Stremio | 502 | +0 |
| [Stremio Downloader](https://github.com/BurningSands70/stremio-downloader) | An application that allows downloading streams from Stremio. | 425 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Bazarr](../r/morpheus65535~bazarr.md) | Bazarr is a companion application to Sonarr and Radarr. It manages and downloads subtitles based on your requirements. Y | 4,284 | +17 |
| [subsync](../r/smacke~subsync.md) | Automagically synchronize subtitles with video. | 7,877 | +8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Sonarr](../r/sonarr~sonarr.md) | Smart PVR for newsgroup and bittorrent users. | 16,364 | +471 |
| [SickGear](../r/sickgear~sickgear.md) | SickGear has proven the most reliable stable TV fork of the great Sick-Beard to fully automate TV enjoyment with innovat | 793 | +0 |
| [SickRage](https://github.com/SiCKRAGE/SiCKRAGE) | Mirror of OFFICIAL SiCKRAGE | 1,528 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [aria-telegram-mirror-bot](https://github.com/out386/aria-telegram-mirror-bot) | A Telegram bot to download files via HTTP(S)/BitTorrent and upload them to Google Drive | 521 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Popcorn Time](../r/popcorn-official~popcorn-desktop.md) | Popcorn Time™ puts everything in one place. Your favorite platforms, your shows, your movies-ready when you are. | 10,687 | +5 |
| [RapidBay](../r/hauxir~rapidbay.md) | Self-hosted torrent video streaming service compatible with Chromecast, AppleTV & Kodi deployable in the cloud | 894 | +2 |
...
| [flood](https://github.com/jfurrow/flood) | A web UI for rTorrent, qBittorrent and Transmission with a Node.js backend and React frontend. Migrate to v4: https://gi | 1,788 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [mktorrent](https://github.com/Rudde/mktorrent) | A simple command line utility to create BitTorrent metainfo files | 553 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [rats-search](../r/degitx~rats-search.md) | rats-search: BitTorrent P2P multi-platform search engine for Desktop and Web servers with integrated torrent client | 1,985 | +6 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [UNIT3D](../r/hdinnovations~unit3d.md) | UNIT3D is a private torrent tracker built using Laravel, Livewire and AlpineJS. | 2,426 | +6 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Jackett](../r/jackett~jackett.md) | API Support for your favorite torrent trackers | 16,053 | +28 |
| [nzbhydra2](../r/theotherp~nzbhydra2.md) | Usenet meta search | 1,724 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [trackerslist](../r/ngosang~trackerslist.md) | Updated list of public BitTorrent trackers | 55,154 | +54 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [SABconnect++](https://github.com/gboudreau/sabconnectplusplus) | SABnzbd extension for Google Chrome | 89 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [spotweb](../r/spotweb~spotweb.md) | Decentralized community | 675 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [newznab-tmux](../r/nntmux~newznab-tmux.md) | Laravel based usenet indexer | 292 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [AdGuard Popup Blocker](../r/adguardteam~popupblocker.md) | Popup blocking userscript | 460 | +3 |
...
| [Windows 10 Privacy Guide](https://github.com/adolfintel/Windows10-Privacy) | Windows 10 Privacy Guide | 1,407 | +0 |
...
| [mreg](https://github.com/Igglybuff/mreg) | Generates a "Match releases" expression for your autodl-irssi filter based on dvdsreleasedates.com's "Most Requested DVD | 16 | +0 |

[Back to top](#awesome-piracy)

---
*Updated: 2026-09-19 | [View live site ↗](https://patrickclery.com/awesomer/l/piracy/)*
