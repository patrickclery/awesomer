...
|---|------|-------|----|-----|-----|
| 1 | [iptv-org/iptv](../r/iptv-org~iptv.md) | 138,673 | +593 | +2,722 | +13,986 |
| 2 | [jellyfin](../r/jellyfin~jellyfin.md) | 57,148 | +258 | +1,325 | +3,777 |
| 3 | [uBlock Origin](../r/gorhill~ublock.md) | 67,851 | +214 | +845 | +2,296 |
| 4 | [Calibre-Web](../r/janeczku~calibre-web.md) | 18,182 | +163 | +313 | +678 |
| 5 | [Sonarr](../r/sonarr~sonarr.md) | 16,170 | +118 | +1,055 | +2,181 |
| 6 | [gallery-dl](../r/mikf~gallery-dl.md) | 19,668 | +67 | +438 | +1,100 |
| 7 | [trackerslist](../r/ngosang~trackerslist.md) | 55,118 | +67 | +236 | +923 |
| 8 | [Jackett](../r/jackett~jackett.md) | 16,035 | +57 | +151 | +444 |
| 9 | [Nebula](../r/slackhq~nebula.md) | 18,340 | +30 | +721 | +935 |
| 10 | [annie](../r/iawia002~annie.md) | 31,678 | +27 | +53 | +263 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [AAXtoMP3](https://github.com/KrumpetPirate/AAXtoMP3) | Convert Audible's .aax filetype to MP3, FLAC, M4A, or OPUS | 1,287 | +0 |
...
| [LazyLibrarian](https://github.com/DobyTang/LazyLibrarian) | This project isn't finished yet. Goal is to create a SickBeard, CouchPotato, Headphones-like application for ebooks. Hea | 724 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [uBlock Origin](../r/gorhill~ublock.md) | uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean. | 67,851 | +214 |
| [Google Unlocked](https://github.com/Ibit-to/google-unlocked) | Google Unlocked browser extension uncensor google search results | 2,394 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [plexdrive](https://github.com/dweidenfeld/plexdrive) | Plexdrive mounts your Google Drive FUSE filesystem (optimized for media playback) | 1,771 | -1 |
| [google-drive-ocamlfuse](../r/astrada~google-drive-ocamlfuse.md) | FUSE filesystem over Google Drive | 5,960 | -2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [annie](../r/iawia002~annie.md) | 👾 Fast and simple video download library and CLI tool written in Go | 31,678 | +27 |
...
| [get_iplayer](https://github.com/get-iplayer/get_iplayer) | A utility for downloading TV and radio programmes from BBC iPlayer and BBC Sounds | 2,543 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Persepolis](../r/persepolisdm~persepolis.md) | Persepolis is a download manager written in Python. | 7,448 | +3 |
| [idm-trial-reset](https://github.com/J2TeaM/idm-trial-reset) | Use IDM forever without cracking | 4,145 | +2 |
...
| [DeDRM_tools](https://github.com/apprenticeharper/DeDRM_tools) | DeDRM tools for ebooks | 15,335 | +8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [gallery-dl](../r/mikf~gallery-dl.md) | Command-line program to download image galleries and collections from several image hosting sites | 19,668 | +67 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [iptv-org/iptv](../r/iptv-org~iptv.md) | Collection of publicly available IPTV channels from all over the world | 138,673 | +593 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [weechat](../r/weechat~weechat.md) | The extensible chat client. | 3,386 | +4 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [HakuNeko](../r/manga-download~hakuneko.md) | Manga & Anime Downloader for Linux, Windows & MacOS | 6,338 | +9 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [jellyfin](../r/jellyfin~jellyfin.md) | The Free Software Media System - Server Backend & API | 57,148 | +258 |
...
| [netflix-proxy](https://github.com/ab77/netflix-proxy) | Smart DNS proxy to watch Netflix | 3,738 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [AnYme](https://github.com/zunjae/anYme) | Unofficial Android Anime App for MyAnimeList | 1,150 | +0 |
...
| [CouchPotato](https://github.com/CouchPotato/CouchPotatoServer) | Automatic Movie Downloading via NZBs & Torrents | 3,870 | -2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Lidarr](../r/lidarr~lidarr.md) | Looks and smells like Sonarr but made for music. | 5,654 | +27 |
...
| [IPTV.bundle](https://github.com/Cigaras/IPTV.bundle) | Plex plug-in that plays live streams (like IPTV) from a M3U playlist | 1,047 | -1 |
...
| [plexupdate](https://github.com/mrworf/plexupdate) | Plex Update script to simplify the life of Linux Plex Media Server users. | 1,876 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Nebula](../r/slackhq~nebula.md) | A scalable overlay networking tool with a focus on performance, simplicity and security | 18,340 | +30 |
...
| [BlockTheSpot](../r/mrpond~blockthespot.md) | Video, audio & banner adblock/skip for Spotify | 12,481 | -8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Sonarr](../r/sonarr~sonarr.md) | Smart PVR for newsgroup and bittorrent users. | 16,170 | +118 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Popcorn Time](../r/popcorn-official~popcorn-desktop.md) | Popcorn Time™ puts everything in one place. Your favorite platforms, your shows, your movies-ready when you are. | 10,687 | +15 |
...
| [ruTorrent](../r/novik~rutorrent.md) | Yet another web front-end for rTorrent | 2,179 | -2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [UNIT3D](../r/hdinnovations~unit3d.md) | UNIT3D is a private torrent tracker built using Laravel, Livewire and AlpineJS. | 2,424 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [trackerslist](../r/ngosang~trackerslist.md) | Updated list of public BitTorrent trackers | 55,118 | +67 |
...
| [nZEDb](https://github.com/nZEDb/nZEDb) | nZEDb - a fork of nnplus(2011) \| NNTP / Usenet / Newsgroup indexer. | 646 | +1 |
...
---
*Updated: 2026-09-15 | [View live site ↗](https://patrickclery.com/awesomer/l/piracy/)*
