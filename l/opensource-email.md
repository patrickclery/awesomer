...
[Home](../README.md) | [Live site ↗](https://patrickclery.com/awesomer/l/opensource-email/) | [Source ↗](https://github.com/Mindbaz/awesome-opensource-email)

## Top 10 Trending

| # | Repo | Stars | 7d | 30d | 90d |
|---|------|-------|----|-----|-----|
| 1 | [Listmonk](../r/knadh~listmonk.md) | 23,387 | +137 | +610 | +1,834 |
| 2 | [Stalwart](../r/stalwartlabs~mail-server.md) | 14,636 | +92 | +497 | +1,473 |
| 3 | [Himalaya](../r/soywod~himalaya.md) | 7,230 | +62 | +218 | +808 |
| 4 | [MailPit](../r/axllent~mailpit.md) | 10,351 | +61 | +253 | +699 |
| 5 | [Docker Mailserver](../r/docker-mailserver~docker-mailserver.md) | 18,844 | +47 | +147 | +473 |
| 6 | [Easy Email](../r/zalify~easy-email.md) | 3,014 | +41 | +185 | +514 |
| 7 | [Maildev](../r/maildev~maildev.md) | 6,049 | +33 | +65 | +121 |
| 8 | [GrapesJS](../r/artf~grapesjs.md) | 26,219 | +30 | +97 | +312 |
| 9 | [Notifuse](../r/notifuse~notifuse.md) | 2,190 | +28 | +145 | +207 |
| 10 | [Postal](../r/postalserver~postal.md) | 16,806 | +24 | +78 | +205 |
...
- [Inbound - Mail Parser](#inbound---mail-parser)
...
|------|-------------|-------|----|
| [Himalaya](../r/soywod~himalaya.md) | CLI to manage emails | 7,230 | +62 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Stalwart](../r/stalwartlabs~mail-server.md) | All-in-one Mail & Collaboration server. Secure, scalable and fluent in every protocol (IMAP, JMAP, SMTP, CalDAV, CardDAV | 14,636 | +92 |
| [Docker Mailserver](../r/docker-mailserver~docker-mailserver.md) | Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running inside a contain | 18,844 | +47 |
| [Mailu](../r/mailu~mailu.md) | Insular email distribution - mail server as Docker images | 7,506 | +13 |
| [Mox](../r/mjl-~mox.md) | modern full-featured open source secure mail server for low-maintenance self-hosted email | 5,852 | +9 |
| [Mailinabox](../r/mail-in-a-box~mailinabox.md) | Mail-in-a-Box helps individuals take back control of their email by defining a one-click, easy-to-deploy SMTP+everything | 15,417 | +5 |
...
| [dmarc-report-converter](../r/tierpod~dmarc-report-converter.md) | Convert dmarc reports from xml to human-readable formats | 279 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [disposable-email-domains](../r/disposable-email-domains~disposable-email-domains.md) | a list of disposable email domains | 5,488 | +16 |
| [disposable](../r/disposable~disposable.md) | A list of disposable/temporary email address domains | 1,446 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Easy Email](../r/zalify~easy-email.md) | Easy Email Editor is a feature-rich, top open-source SaaS email editor based on React and MJML. | 3,014 | +41 |
| [GrapesJS](../r/artf~grapesjs.md) | Free and Open source Web Builder Framework. Next generation tool for building templates without coding | 26,219 | +30 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Maildev](../r/maildev~maildev.md) | 📫 SMTP Server + Web Interface for viewing and testing emails during development. | 6,049 | +33 |
| [Inbucket](../r/inbucket~inbucket.md) | Disposable webmail server (similar to Mailinator) with built in SMTP, POP3, RESTful servers; no DB required. | 2,283 | +18 |
...
| [SMTP4dev](../r/rnwood~smtp4dev.md) | smtp4dev - the fake smtp email server for development and testing | 3,972 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Anonaddy](../r/anonaddy~anonaddy.md) | Anonymous email forwarding | 4,837 | +9 |
...
| [Maizzle](../r/maizzle~framework.md) | The modern email development framework. | 1,608 | +3 |
...
| [Roundcube](../r/roundcube~roundcubemail.md) | The Roundcube Webmail suite | 7,171 | +4 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [JMAP](../r/jmapio~jmap.md) | JSON Meta Application Protocol Specification (JMAP) | 1,371 | +3 |
| [James](../r/apache~james-project.md) | Emails at the heart of your business logic! | 1,042 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [go-mail](../r/wneessen~go-mail.md) | 📧 Easy to use, yet comprehensive library for sending mails with Go | 1,484 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Mautic](../r/mautic~mautic.md) | Mautic: Open Source Marketing Automation Software. | 10,495 | +21 |
| [Plunk](../r/useplunk~plunk.md) | The Open-Source Email Platform | 5,461 | +18 |
| [Sendportal](../r/mettle~sendportal.md) | Open-source self-hosted email marketing. Manage your own newsletters at a fraction of the cost.  | 2,171 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Listmonk](../r/knadh~listmonk.md) | High performance, self-hosted, newsletter and mailing list manager with a modern dashboard. Single binary app. | 23,387 | +137 |
| [Notifuse](../r/notifuse~notifuse.md) | Open-source, self-hosted newsletter, email marketing and transactional email platform. Visual MJML editor, Liquid templa | 2,190 | +28 |
| [Keila](../r/pentacent~keila.md) | Open Source Newsletter Tool. | 2,209 | +4 |
| [Mailtrain](../r/mailtrain-org~mailtrain.md) | Self hosted newsletter app | 5,750 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Imapsync](../r/imapsync~imapsync.md) | Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP | 4,147 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [SimpleLogin](../r/simple-login~app.md) | The SimpleLogin back-end and web app | 6,981 | +23 |
...
| [Maddy](../r/foxcpp~maddy.md) | ✉️ Composable all-in-one mail server. | 6,085 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [MailPit](../r/axllent~mailpit.md) | An email and SMTP testing tool with API for developers | 10,351 | +61 |
| [MailHog](../r/mailhog~mailhog.md) | Web and API based SMTP testing | 16,149 | +13 |
...
---
*Updated: 2026-09-13 | [View live site ↗](https://patrickclery.com/awesomer/l/opensource-email/)*
