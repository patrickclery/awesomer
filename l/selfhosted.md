...
|---|------|-------|----|-----|-----|
| 1 | [Vaultwarden](../r/dani-garcia~vaultwarden.md) | 67,215 | +621 | +1,861 | +4,885 |
| 2 | [Stirling-PDF](../r/stirling-tools~stirling-pdf.md) | 91,834 | +614 | +2,388 | +10,978 |
| 3 | [Vane](../r/itzcrazykns~vane.md) | 36,710 | +234 | +594 | +1,417 |
| 4 | [Meelo](../r/arthi-chaud~meelo.md) | 1,418 | +219 | +249 | +269 |
| 5 | [Calibre Web](../r/janeczku~calibre-web.md) | 18,172 | +163 | +324 | +682 |
| 6 | [Homepage by gethomepage](../r/gethomepage~homepage.md) | 32,534 | +145 | +559 | +1,874 |
| 7 | [Glance](../r/glanceapp~glance.md) | 36,999 | +145 | +662 | +1,911 |
| 8 | [SeaweedFS](../r/seaweedfs~seaweedfs.md) | 34,605 | +137 | +561 | +1,705 |
| 9 | [code-server](../r/coder~code-server.md) | 79,269 | +134 | +470 | +1,326 |
| 10 | [copyparty](../r/9001~copyparty.md) | 46,643 | +116 | +441 | +1,426 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Bichon](../r/rustmailer~bichon.md) | Bichon – A lightweight, high-performance Rust email archiver with WebUI | 1,945 | +14 |
| [mail-archiver](../r/s1t5~mail-archiver.md) | Mail-Archiver is a web application for archiving, searching, and exporting emails from multiple accounts. Featuring fold | 2,097 | +14 |
...
| [Cronmaster](../r/fccview~cronmaster.md) | Cronjob management UI with human readable syntax, live logging and log history for your cronjobs. | 1,363 | +5 |
| [Matchering](../r/sergree~matchering.md) | 🎚️ Open Source Audio Matching and Mastering | 2,628 | +5 |
| [BookBounty](../r/thewicklowwolf~bookbounty.md) | Retrieve missing Readarr books from Library Genesis. | 291 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Backups](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Shiori](../r/go-shiori~shiori.md) | Simple bookmark manager built with Go | 11,636 | +22 |
...
| [Shaarli](../r/shaarli~shaarli.md) | The personal, minimalist, super-fast, database free, bookmarking service - community repo | 3,897 | +1 |
| [Slash](../r/yourselfhosted~slash.md) | An open source, self-hosted platform for sharing and managing your most frequently used links. Easily create customizabl | 3,176 | -1 |
...
| [Xandikos](../r/jelmer~xandikos.md) | A CalDAV/CardDAV server backed by Git | 605 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Apprise](../r/caronc~apprise.md) | Apprise - Push Notifications that work with just about every platform! | 17,307 | +106 |
| [SimpleX Chat](../r/simplex-chat~simplex-chat.md) | SimpleX - the first messaging network operating without user identifiers of any kind - 100% private by design! iOS, Andr | 19,420 | +33 |
| [WBO](../r/lovasoa~whitebophir.md) | Online collaborative Whiteboard that is simple, free, easy to use and  to deploy | 2,642 | +4 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Stirling-PDF](../r/stirling-tools~stirling-pdf.md) | #1 PDF Application on GitHub that lets you edit PDFs on any device anywhere | 91,834 | +614 |
...
| [Calibre Web Automated](../r/crocodilestick~calibre-web-automated.md) | Calibre-Web but Automated and with tons of New Features! Fully automate and simplify your eBook set up! | 6,263 | +35 |
| [kiwix-serve](../r/kiwix~kiwix-tools.md) | Command line Kiwix tools: kiwix-serve, kiwix-manage, ... | 948 | +7 |
| [BookLogr](../r/mozzo1000~booklogr.md) |  A simple, self-hosted service to keep track of your personal library 📚 | 618 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Open Source POS](../r/opensourcepos~opensourcepos.md) | Open Source Point of Sale is a web based point of sale application written in PHP using CodeIgniter framework. It uses M | 4,381 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Awesome Sysadmin](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
| [Awesome Big Data](../r/0xnr~awesome-bigdata.md) | A curated list of awesome big data frameworks, ressources and other awesomeness. | 14,633 | +11 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Identity Management](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
...
| [RSS-Bridge](../r/rss-bridge~rss-bridge.md) | The RSS feed for websites missing it | 9,232 | +12 |
...
| [RSS Monster](../r/pietheinstrengholt~rssmonster.md) | Modern, self-hosted RSS reader with smart folders, powerful search, and a clean three-pane reading experience. Built wit | 538 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Distributed Filesystems](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [SeaweedFS](../r/seaweedfs~seaweedfs.md) | SeaweedFS is a distributed storage system for object storage (S3), file systems, and Iceberg tables, designed to handle  | 34,605 | +137 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [slskd](../r/slskd~slskd.md) | A modern client-server application for the Soulseek file sharing network. | 3,896 | +41 |
...
| [Gokapi](../r/forceu~gokapi.md) | Lightweight selfhosted Firefox Send alternative without public upload. AWS S3 supported. | 2,863 | +7 |
| [Uguu](../r/nokonoko~uguu.md) | Uguu is a simple lightweight temporary file host with support for drop, paste, click and API uploading. | 1,216 | +5 |
| [OnionShare](../r/onionshare~onionshare.md) | Securely and anonymously share files, host websites, and chat with friends using the Tor network | 7,087 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Pingvin Share X](../r/smp46~pingvin-share-x.md) | Pingvin Share X is a secure and easy self-hosted file sharing platform. | 422 | +18 |
| [PicoShare](../r/mtlynch~picoshare.md) | A minimalist, easy-to-host service for sharing images and other files | 3,031 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [copyparty](../r/9001~copyparty.md) | Portable file server with accelerated resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbn | 46,643 | +116 |
| [miniserve](../r/svenstaro~miniserve.md) | 🌟 For when you really just want to serve some files over HTTP right now! | 7,850 | +22 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [The Battle for Wesnoth](../r/wesnoth~wesnoth.md) | An open source, turn-based strategy game with a high fantasy theme. | 6,872 | +17 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Razzia](../r/ralex91~razzia.md) | A self-hosted, open-source quiz platform for smaller events. | 1,016 | +11 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Vane](../r/itzcrazykns~vane.md) | Vane is an AI-powered answering engine. | 36,710 | +234 |
| [Local Deep Research](../r/learningcircuit~local-deep-research.md) |  ~95% on SimpleQA (e.g. Qwen3.6-27B on a 3090). Supports all local and cloud LLMs (llama.cpp, Ollama, Google, ...). 10+  | 9,078 | +48 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Spoolman](../r/donkie~spoolman.md) | Keep track of your inventory of 3D-printer filament spools. | 2,812 | +17 |
| [DVinyl](../r/kyonew~dvinyl.md) | DVinyl is a self-hostable collection management platform for collectors. Catalog, organize and track physical media and  | 214 | +11 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [wanderer](../r/open-wanderer~wanderer.md) | wanderer is a self-hosted trail database. Save your adventures! | 3,871 | +15 |
| [OwnTracks Recorder](../r/owntracks~recorder.md) | Store and access data published by OwnTracks apps | 1,201 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [MeTube](../r/alexta69~metube.md) | Self-hosted video downloader for YouTube and other sites (web UI for yt-dlp) | 14,703 | +74 |
| [Seerr](../r/seerr-team~seerr.md) | Open-source media request and discovery manager for Jellyfin, Plex, and Emby. | 12,566 | +73 |
| [Pinchflat](../r/kieraneglin~pinchflat.md) | Your next YouTube media manager | 5,307 | +16 |
...
| [yt-dlp Web UI](../r/marcopiovanello~yt-dlp-web-ui.md) | A terrible web ui and RPC server for yt-dlp. Designed to be self-hosted. | 2,580 | +10 |
| [tubesync](../r/meeb~tubesync.md) | Syncs YouTube channels and playlists to a locally hosted media server | 2,790 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Youtarr](../r/dialmasterorg~youtarr.md) | Self-hosted web app that automates downloading, organizing, and scheduling YouTube channel content with support for Plex | 1,564 | +18 |
| [MyTube](../r/franklioxygen~mytube.md) | Self-hosted downloader and player for YouTube, Bilibili, Twitch, MissAV, and yt-dlp sites. Features channel subscription | 1,183 | +10 |
| [Deleterr](../r/rfsbraz~deleterr.md) |   Automated Plex media cleanup with watch-based rules, smart exclusions, and "Leaving Soon" notifications via Radarr, So | 335 | +0 |
| [Elengrab](../r/neosy~elengrab.md) | Fast cross-platform video and audio downloader and media viewer with flexible format and quality options. Supports 1,000 | 29 |  |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Snapcast](../r/snapcast~snapcast.md) | Synchronous multiroom audio player | 7,864 | +19 |
| [LMS](../r/epoupon~lms.md) | Lightweight Music Server. Access your self-hosted music using a web interface. | 1,670 | +7 |
...
| [vod2pod-rss](../r/madiele~vod2pod-rss.md) | Vod2Pod-RSS converts a YouTube or Twitch channel into a podcast with ease. It creates a podcast RSS that can be listened | 384 | +1 |
...
| [Kyoo](../r/zoriya~kyoo.md) | A portable and vast media library solution. | 2,521 | +8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Invidious](../r/iv-org~invidious.md) | Invidious is an alternative front-end to YouTube | 24,402 | +72 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ConvertX](../r/c4illin~convertx.md) | 💾 Self-hosted online file converter. Supports 1000+ formats ⚙️ | 18,948 | +97 |
...
| [CyberChef](../r/gchq~cyberchef.md) | The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis | 35,815 | +57 |
| [Yamtrack](../r/fuzzygrim~yamtrack.md) | A self hosted media tracker. | 3,532 | +40 |
| [iSponsorBlockTV](../r/dmunozv04~isponsorblocktv.md) | SponsorBlock client for all YouTube TV clients. | 6,072 | +23 |
| [2FAuth](../r/bubka~2fauth.md) | A Web app to manage your Two-Factor Authentication (2FA) accounts and generate their security codes | 4,148 | +16 |
| [ClipCascade](../r/sathvik-rao~clipcascade.md) | ClipCascade is a lightweight utility that automatically syncs the clipboard across devices, no key press required. | 1,910 | +12 |
| [IT-Tools by sharevb](../r/sharevb~it-tools.md) | My additions (and of others) to it-tools! (Collection of handy online tools for developers, with great UX. ) | 1,607 | +11 |
| [google-webfonts-helper](../r/majodev~google-webfonts-helper.md) | A Hassle-Free Way to Self-Host Google Fonts. Get eot, ttf, svg, woff and woff2 files + CSS snippets | 13,066 | +9 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Sure](../r/we-promise~sure.md) | The personal finance app for everyone (by everyone) | 9,880 | +95 |
| [ExpenseOwl](../r/tanq16~expenseowl.md) | Extremely simple, self-hosted expense tracker with a beautiful UI. | 1,506 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Monitoring](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Upsnap](../r/seriousm4x~upsnap.md) | A simple wake on lan web app written with SvelteKit, Go and PocketBase. | 6,270 | +28 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [TriliumNext Notes](../r/triliumnext~trilium.md) | Build your personal knowledge base with Trilium Notes | 37,806 | +102 |
...
| [Many Notes](../r/brufdev~many-notes.md) | Markdown note-taking web application designed for simplicity | 1,081 | +12 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Yopass](../r/jhaals~yopass.md) | Secure sharing of secrets, passwords and files  | 3,125 | +16 |
| [Wastebin](../r/matze~wastebin.md) | wastebin is a pastebin 📝 | 853 | +5 |
| [ByteStash](../r/jordan-dalby~bytestash.md) | A code snippet storage solution written in React & node.js | 2,532 | +4 |
| [rustypaste](../r/orhun~rustypaste.md) | A minimal file upload/pastebin service. | 1,202 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Glance](../r/glanceapp~glance.md) | A self-hosted dashboard that puts all your feeds in one place | 36,999 | +145 |
| [Homepage by gethomepage](../r/gethomepage~homepage.md) | A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations. | 32,534 | +145 |
| [Your Spotify](../r/yooooomi~your_spotify.md) | Self hosted Spotify tracking dashboard | 4,575 | +21 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Immich Kiosk](../r/damongolding~immich-kiosk.md) | Highly configurable slideshows for displaying Immich assets on browsers and devices. | 1,668 | +9 |
| [LibrePhotos](../r/librephotos~librephotos.md) | A self-hosted open source photo management service.  | 8,068 | +6 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [RecipeSage](../r/julianpoy~recipesage.md) | A Collaborative Recipe Keeper, Meal Planner, and Shopping List Organizer in PWA form. | 958 | +9 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Warpgate](../r/warp-tech~warpgate.md) | Fully transparent SSH, HTTPS, Kubernetes, database and RDP/VNC bastion/PAM that doesn't need additional client-side soft | 7,870 | +79 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Manticore Search](../r/manticoresoftware~manticoresearch.md) | Open-source search database for full-text, vector, and hybrid search with real-time indexing and SQL. | 11,998 | +8 |
| [Websurfx](../r/neon-mmd~websurfx.md) | 🚀 An open source alternative to searx which provides a modern-looking ✨, lightning-fast ⚡, privacy respecting 🥸, secur | 1,194 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Continuous Integration & Continuous Deployment](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/PaaS](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [code-server](../r/coder~code-server.md) | VS Code in the browser | 79,269 | +134 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [WebHook Tester](../r/tarampampam~webhook-tester.md) | 🔭 Powerful tool for testing WebHooks and more | 533 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Tasks.md](../r/baldissaramatheus~tasks.md.md) | A self-hosted, Markdown file based task management board | 2,196 | +8 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/VPN](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,130 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [go-doxy](../r/yusing~godoxy.md) | High-performance reverse proxy and container orchestrator for self-hosters | 4,151 | +33 |
| [SWAG (Secure Web Application Gateway)](../r/linuxserver~docker-swag.md) | Nginx webserver and reverse proxy with php support and a built-in Certbot (Let's Encrypt) client. It also contains fail2 | 3,722 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [LeafWiki](../r/perber~leafwiki.md) | LeafWiki - Self-hosted wiki. Single Go binary, SQLite, Markdown on disk. No external database required. | 1,127 | +13 |
...
| [Gitit](../r/jgm~gitit.md) | A wiki using HAppS, pandoc, and git | 2,273 | +1 |

[Back to top](#awesome-selfhosted)

---
*Updated: 2026-09-13 | [View live site ↗](https://patrickclery.com/awesomer/l/selfhosted/)*
