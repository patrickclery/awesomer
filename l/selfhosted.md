...
[Home](../README.md) | [Live site ↗](https://patrickclery.com/awesomer/l/selfhosted/) | [Source ↗](https://github.com/awesome-selfhosted/awesome-selfhosted)

## Top 10 Trending

| # | Repo | Stars | 7d | 30d | 90d |
|---|------|-------|----|-----|-----|
| 1 | [Vaultwarden](../r/dani-garcia~vaultwarden.md) | 67,630 | +621 | +2,160 | +5,181 |
| 2 | [Stirling-PDF](../r/stirling-tools~stirling-pdf.md) | 92,133 | +614 | +2,559 | +10,958 |
| 3 | [Vane](../r/itzcrazykns~vane.md) | 36,854 | +234 | +667 | +1,526 |
| 4 | [Meelo](../r/arthi-chaud~meelo.md) | 1,419 | +219 | +245 | +271 |
| 5 | [Calibre Web](../r/janeczku~calibre-web.md) | 18,182 | +163 | +313 | +678 |
| 6 | [Homepage by gethomepage](../r/gethomepage~homepage.md) | 32,628 | +145 | +587 | +1,936 |
| 7 | [Glance](../r/glanceapp~glance.md) | 37,056 | +145 | +666 | +1,859 |
| 8 | [SeaweedFS](../r/seaweedfs~seaweedfs.md) | 34,675 | +137 | +596 | +1,706 |
| 9 | [code-server](../r/coder~code-server.md) | 79,299 | +134 | +430 | +1,343 |
| 10 | [copyparty](../r/9001~copyparty.md) | 46,684 | +116 | +456 | +1,437 |
...
| [Statistics for Strava](https://github.com/robiningelbrecht/statistics-for-strava) | Self-hosted, open-source dashboard for your sports and fitness data | 8 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Bichon](../r/rustmailer~bichon.md) | Bichon – A lightweight, high-performance Rust email archiver with WebUI | 1,949 | +14 |
| [mail-archiver](../r/s1t5~mail-archiver.md) | Mail-Archiver is a web application for archiving, searching, and exporting emails from multiple accounts. Featuring fold | 2,100 | +14 |
...
| [Cronmaster](../r/fccview~cronmaster.md) | Cronjob management UI with human readable syntax, live logging and log history for your cronjobs. | 1,365 | +5 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Backups](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Shiori](../r/go-shiori~shiori.md) | Simple bookmark manager built with Go | 11,642 | +22 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Davis](../r/tchapi~davis.md) | 🗓 A modern, simple, feature-packed, fully translatable admin interface for sabre/dav based on Symfony 7 and Bootstrap | 748 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Apprise](../r/caronc~apprise.md) | Apprise - Push Notifications that work with just about every platform! | 17,327 | +106 |
| [SimpleX Chat](../r/simplex-chat~simplex-chat.md) | SimpleX - the first messaging network operating without user identifiers of any kind - 100% private by design! iOS, Andr | 19,438 | +33 |
| [WBO](../r/lovasoa~whitebophir.md) | Online collaborative Whiteboard that is simple, free, easy to use and  to deploy | 2,646 | +4 |
| [Databag](../r/balzack~databag.md) | fast & lightweight self-hosted messenger | 1,488 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Redlib](../r/redlib-org~redlib.md) |  Private front-end for Reddit  | 3,748 | +25 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [teikei](https://github.com/teikei/teikei) | A web application that maps out community-supported agriculture in Germany, Switzerland, and Austria, based on crowdsour | 66 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Stirling-PDF](../r/stirling-tools~stirling-pdf.md) | #1 PDF Application on GitHub that lets you edit PDFs on any device anywhere | 92,133 | +614 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Calibre Web](../r/janeczku~calibre-web.md) | 📚 Web app for browsing, reading and downloading eBooks stored in a Calibre database | 18,182 | +163 |
| [Calibre Web Automated](../r/crocodilestick~calibre-web-automated.md) | Calibre-Web but Automated and with tons of New Features! Fully automate and simplify your eBook set up! | 6,283 | +35 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Open Source POS](../r/opensourcepos~opensourcepos.md) | Open Source Point of Sale is a web based point of sale application written in PHP using CodeIgniter framework. It uses M | 4,385 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Awesome Sysadmin](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
| [Awesome Big Data](../r/0xnr~awesome-bigdata.md) | A curated list of awesome big data frameworks, ressources and other awesomeness. | 14,637 | +11 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Identity Management](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Yarr](../r/nkanaev~yarr.md) | yet another rss reader | 4,040 | +18 |
| [RSS-Bridge](../r/rss-bridge~rss-bridge.md) | The RSS feed for websites missing it | 9,234 | +12 |
| [Fusion](../r/0x2e~fusion.md) | A lightweight, self-hosted friendly RSS reader | 2,174 | +11 |
| [Stringer](../r/stringer-rss~stringer.md) | A self-hosted, anti-social RSS reader. | 4,132 | +5 |
| [RSS Monster](../r/pietheinstrengholt~rssmonster.md) | Modern, self-hosted RSS reader with smart folders, powerful search, and a clean three-pane reading experience. Built wit | 543 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Distributed Filesystems](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [SeaweedFS](../r/seaweedfs~seaweedfs.md) | SeaweedFS is a distributed storage system for object storage (S3), file systems, and Iceberg tables, designed to handle  | 34,675 | +137 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [slskd](../r/slskd~slskd.md) | A modern client-server application for the Soulseek file sharing network. | 3,909 | +41 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Zipline](../r/diced~zipline.md) | A ShareX/file upload server that is easy to use, packed with features, and with an easy setup! | 3,415 | +19 |
| [Gokapi](../r/forceu~gokapi.md) | Lightweight selfhosted Firefox Send alternative without public upload. AWS S3 supported. | 2,869 | +7 |
| [Uguu](../r/nokonoko~uguu.md) | Uguu is a simple lightweight temporary file host with support for drop, paste, click and API uploading. | 1,220 | +5 |
| [OnionShare](../r/onionshare~onionshare.md) | Securely and anonymously share files, host websites, and chat with friends using the Tor network | 7,089 | +3 |
...
| [Plik](../r/root-gg~plik.md) | Plik is a temporary file upload system (Wetransfer like) in Go. | 1,821 | +0 |
| [Shifter](https://github.com/TobySuch/Shifter) | A simple, self-hosted file-sharing web app | 42 | +0 |
| [Sharry](../r/eikek~sharry.md) | Sharry is a self-hosted file sharing web application. | 1,346 | -1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Pingvin Share X](../r/smp46~pingvin-share-x.md) | Pingvin Share X is a secure and easy self-hosted file sharing platform. | 431 | +18 |
| [PicoShare](../r/mtlynch~picoshare.md) | A minimalist, easy-to-host service for sharing images and other files | 3,035 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [copyparty](../r/9001~copyparty.md) | Portable file server with accelerated resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, media indexer, thumbn | 46,684 | +116 |
| [miniserve](../r/svenstaro~miniserve.md) | 🌟 For when you really just want to serve some files over HTTP right now! | 7,857 | +22 |
| [FileRise](../r/error311~filerise.md) | 🗂️ FileRise – lightweight, self-hosted file manager & storage hub with granular ACLs, resumable uploads, encrypted fold | 1,013 | +4 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [The Battle for Wesnoth](../r/wesnoth~wesnoth.md) | An open source, turn-based strategy game with a high fantasy theme. | 6,876 | +17 |
| [A Dark Room](https://github.com/doublespeakgames/adarkroom) | A Dark Room - A Minimalist Text Adventure | 8,283 | +16 |
| [Hypersomnia](../r/teamhypersomnia~hypersomnia.md) | Multiplayer top-down shooter made from scratch in C++. Web version: https://play.hypersomnia.io Made in 🇵🇱 | 1,644 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Ownfoil](../r/a1ex4~ownfoil.md) | Nintendo Switch library manager, with automated management tasks, serving your library to multiple supported clients on  | 912 | +5 |
...
| [Retrom](../r/jmberesford~retrom.md) | A centralized game library/collection management service with a focus on emulation | 2,072 | +4 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Vane](../r/itzcrazykns~vane.md) | Vane is an AI-powered answering engine. | 36,854 | +234 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [LHA](https://github.com/javalikescript/lha) | light home automation application | 13 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Spoolman](../r/donkie~spoolman.md) | Keep track of your inventory of 3D-printer filament spools. | 2,821 | +17 |
| [DVinyl](../r/kyonew~dvinyl.md) | DVinyl is a self-hostable collection management platform for collectors. Catalog, organize and track physical media and  | 217 | +11 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [wanderer](../r/open-wanderer~wanderer.md) | wanderer is a self-hosted trail database. Save your adventures! | 3,876 | +15 |
| [OwnTracks Recorder](../r/owntracks~recorder.md) | Store and access data published by OwnTracks apps | 1,204 | +1 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [MeTube](../r/alexta69~metube.md) | Self-hosted video downloader for YouTube and other sites (web UI for yt-dlp) | 14,737 | +74 |
| [Seerr](../r/seerr-team~seerr.md) | Open-source media request and discovery manager for Jellyfin, Plex, and Emby. | 12,590 | +73 |
| [Pinchflat](../r/kieraneglin~pinchflat.md) | Your next YouTube media manager | 5,314 | +16 |
| [Watcharr](../r/sbondco~watcharr.md) | Open source, self-hostable watched list for all your content (movies, tv series, anime, games) with user authentication, | 1,501 | +13 |
| [yt-dlp Web UI](../r/marcopiovanello~yt-dlp-web-ui.md) | A terrible web ui and RPC server for yt-dlp. Designed to be self-hosted. | 2,582 | +10 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Youtarr](../r/dialmasterorg~youtarr.md) | Self-hosted web app that automates downloading, organizing, and scheduling YouTube channel content with support for Plex | 1,567 | +18 |
| [MyTube](../r/franklioxygen~mytube.md) | Self-hosted downloader and player for YouTube, Bilibili, Twitch, MissAV, and yt-dlp sites. Features channel subscription | 1,198 | +10 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Snapcast](../r/snapcast~snapcast.md) | Synchronous multiroom audio player | 7,869 | +19 |
...
| [Polaris](../r/agersant~polaris.md) | Polaris is a music streaming application, designed to let you enjoy your music collection from any computer or mobile de | 2,728 | +4 |
| [gonic](../r/sentriz~gonic.md) | music streaming server / free-software subsonic server API implementation | 2,542 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Invidious](../r/iv-org~invidious.md) | Invidious is an alternative front-end to YouTube | 24,435 | +72 |
...
| [SyncTube](../r/rblsb~synctube.md) | Synchronized video viewing with chat and other features (one-channel web service) | 390 | -1 |
| [Tiramisu](../r/mrrobotogit~tiramisu.md) | The most advanced BitTorrent engine and FUSE virtual filesystem for live streaming to your private Plex or Jellyfin libr | 140 | -3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [ConvertX](../r/c4illin~convertx.md) | 💾 Self-hosted online file converter. Supports 1000+ formats ⚙️ | 18,984 | +97 |
| [TeslaMate](../r/teslamate-org~teslamate.md) | A self-hosted data logger for your Tesla  🚘 [main maintainer=@JakobLichterfeld] | 8,990 | +60 |
| [CyberChef](../r/gchq~cyberchef.md) | The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis | 35,843 | +57 |
| [Yamtrack](../r/fuzzygrim~yamtrack.md) | A self hosted media tracker. | 3,543 | +40 |
| [iSponsorBlockTV](../r/dmunozv04~isponsorblocktv.md) | SponsorBlock client for all YouTube TV clients. | 6,089 | +23 |
| [2FAuth](../r/bubka~2fauth.md) | A Web app to manage your Two-Factor Authentication (2FA) accounts and generate their security codes | 4,152 | +16 |
| [ClipCascade](../r/sathvik-rao~clipcascade.md) | ClipCascade is a lightweight utility that automatically syncs the clipboard across devices, no key press required. | 1,914 | +12 |
| [IT-Tools by sharevb](../r/sharevb~it-tools.md) | My additions (and of others) to it-tools! (Collection of handy online tools for developers, with great UX. ) | 1,625 | +11 |
...
| [Baby Buddy](../r/babybuddy~babybuddy.md) | A 👶 buddy to help caregivers track sleep, feedings, diaper changes, tummy time and more to learn about and predict baby | 2,884 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Sure](../r/we-promise~sure.md) | The personal finance app for everyone (by everyone) | 9,921 | +95 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Monitoring](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Upsnap](../r/seriousm4x~upsnap.md) | A simple wake on lan web app written with SvelteKit, Go and PocketBase. | 6,275 | +28 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [TriliumNext Notes](../r/triliumnext~trilium.md) | Build your personal knowledge base with Trilium Notes | 37,854 | +102 |
| [flatnotes](../r/dullage~flatnotes.md) | A self-hosted, database-less note taking web app that utilises a flat folder of markdown files for storage. | 3,222 | +20 |
| [Many Notes](../r/brufdev~many-notes.md) | Markdown note-taking web application designed for simplicity | 1,084 | +12 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Vaultwarden](../r/dani-garcia~vaultwarden.md) | Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs | 67,630 | +621 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Yopass](../r/jhaals~yopass.md) | Secure sharing of secrets, passwords and files  | 3,132 | +16 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Snipo](https://github.com/MohamedElashri/snipo) | Single user snippet manager web app.  | 71 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Glance](../r/glanceapp~glance.md) | A self-hosted dashboard that puts all your feeds in one place | 37,056 | +145 |
| [Homepage by gethomepage](../r/gethomepage~homepage.md) | A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations. | 32,628 | +145 |
| [Your Spotify](../r/yooooomi~your_spotify.md) | Self hosted Spotify tracking dashboard | 4,577 | +21 |
| [ryot](../r/ignisda~ryot.md) | Roll your own tracker! | 3,592 | +15 |
| [Homer](../r/bastienwirtz~homer.md) | A very simple static homepage for your server. | 11,599 | +13 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Immich Kiosk](../r/damongolding~immich-kiosk.md) | Highly configurable slideshows for displaying Immich assets on browsers and devices. | 1,673 | +9 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [sish](../r/antoniomika~sish.md) | HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH. | 4,716 | +7 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Warpgate](../r/warp-tech~warpgate.md) | Fully transparent SSH, HTTPS, Kubernetes, database and RDP/VNC bastion/PAM that doesn't need additional client-side soft | 7,881 | +79 |
...
| [Sshwifty](../r/nirui~sshwifty.md) | Web SSH & Telnet (WebSSH & WebTelnet client) 🔮 | 3,125 | +0 |
...
| [Websurfx](../r/neon-mmd~websurfx.md) | 🚀 An open source alternative to searx which provides a modern-looking ✨, lightning-fast ⚡, privacy respecting 🥸, secur | 1,196 | +5 |
| [Meme Search](../r/neonwatty~meme-search.md) | The open source Meme Search Engine and Finder.  Free and built to self-host locally with Python, Ruby, and Docker. | 744 | +3 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [NextCloudPi](../r/nextcloud~nextcloudpi.md) | 📦 Build code for NextcloudPi: Raspberry Pi, Odroid, Rock64, curl installer... | 2,939 | +3 |
| [Self Host Blocks](../r/ibizaman~selfhostblocks.md) | Modular server management based on NixOS modules and focused on best practices. | 496 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/Continuous Integration & Continuous Deployment](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/PaaS](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [minimal-git-server](https://github.com/mcarbonne/minimal-git-server) | Minimal git server running in a container (docker, podman...) | 47 | +0 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [Tasks.md](../r/baldissaramatheus~tasks.md.md) | A self-hosted, Markdown file based task management board | 2,200 | +8 |
...
| [Nullboard](https://github.com/apankrat/nullboard) | Nullboard is a minimalist kanban board, focused on compactness and readability. | 4,146 | +2 |
...
| Repo | Description | Stars | 7d |
|------|-------------|-------|----|
| [awesome-sysadmin/VPN](../r/awesome-foss~awesome-sysadmin.md) | A curated list of amazingly awesome open-source sysadmin resources. | 35,154 | +63 |
...
| [motionEye](../r/motioneye-project~motioneye.md) | A web frontend for the motion daemon. | 4,674 | +4 |
...
| [django-wiki](../r/django-wiki~django-wiki.md) | A wiki system with complex functionality for simple integration and a superb interface. Store your knowledge with style: | 1,935 | +1 |
| [Gitit](../r/jgm~gitit.md) | A wiki using HAppS, pandoc, and git | 2,274 | +1 |

[Back to top](#awesome-selfhosted)

---
*Updated: 2026-09-15 | [View live site ↗](https://patrickclery.com/awesomer/l/selfhosted/)*
