...
- [Square Shooter](https://github.com/namzug16/squareshooter_flame) - A simple 2D top-down shooter for the web. Play solo vs AI or sit back and let the AI battle its own. By [Namzug](https://namzug.dev/). <!--lint ignore double-link-->
...
- [Darkness Dungeon](https://github.com/RafaelBarbosatec/darkness_dungeon) - Simple RPG. By [rafaelbarbosatec](http://rafaelbarbosatec.github.io/) <!--lint ignore double-link--> <!--lint ignore double-link--> <!--lint ignore double-link--> <!--lint ignore double-link-->
