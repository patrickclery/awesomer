...
|----------------------------------------------|---------------------------------------------------------------|-------|-------------|
| [kunkun](https://github.com/kunkunsh/kunkun) | Raycast/Alfred-like launcher with sandboxed extensions ![oss] | 995   | 2025-04-03  |
...
| Name                                             | Description                                                                                                                        | Stars | Last Commit |
|--------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|-------|-------------|
| [Equicord](https://github.com/Equicord/Equicord) | Fork of Vencord with additional plugins and features. [![Open-Source Software][oss]](https://github.com/Equicord/Equicord) ![star] | 605   | 2025-05-29  |
...
| Name                                                                                   | Description                                                                                                                                                 | Stars | Last Commit |
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|-------------|
| [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) | Fast and stable Redis GUI client with cluster, sentinel, SSH support. [![Open-Source Software][oss]](https://github.com/qishibo/AnotherRedisDesktopManager) | 32378 | 2025-03-25  |

## File Management

| Name                                               | Description                   | Stars | Last Commit |
|----------------------------------------------------|-------------------------------|-------|-------------|
| [fselect](https://github.com/jhspetersson/fselect) | SQL-like file search utility. | 4261  | 2025-05-28  |
...
| Name                                                      | Description                                                                                                                     | Stars | Last Commit |
|-----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|-------|-------------|
| [Vaultwarden](https://github.com/dani-garcia/vaultwarden) | Lightweight Bitwarden server implementation. [![Open-Source Software][oss]](https://github.com/dani-garcia/vaultwarden) ![star] | 44933 | 2025-05-27  |
...
| Name                                        | Description                      | Stars | Last Commit |
|---------------------------------------------|----------------------------------|-------|-------------|
| [Algo](https://github.com/trailofbits/algo) | Personal IPSEC VPN in the cloud. | 29408 | 2024-08-30  |

## Remote Access

| Name                                                          | Description                                                                                                                                             | Stars | Last Commit |
|---------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------|-------------|
| [Sunshine](https://github.com/LizardByte/Sunshine)            | Open-source self-hosted game streaming server for use with Moonlight. [![Open-Source Software][oss]](https://github.com/LizardByte/Sunshine)            | 25847 | 2025-05-28  |
| [Moonlight](https://github.com/moonlight-stream/moonlight-qt) | Open-source GameStream client for Windows, Mac, Linux, and Steam Link. [![Open-Source Software][oss]](https://github.com/moonlight-stream/moonlight-qt) | 13240 | 2025-05-27  |
...
| Name                                             | Description                                   | Stars | Last Commit |
|--------------------------------------------------|-----------------------------------------------|-------|-------------|
| [Capter](https://github.com/decipher3114/Capter) | A simple screenshot tool made in rust. ![oss] | 148   | 2025-05-28  |
...
| Name                                                 | Description                                               | Stars  | Last Commit |
|------------------------------------------------------|-----------------------------------------------------------|--------|-------------|
| [FancyZones](https://github.com/microsoft/PowerToys) | PowerToys window manager for multi-monitor setups. ![oss] | 119486 | 2025-05-29  |
| [GlazeWM](https://github.com/glzr-io/glazewm)        | Rust-based tiling window manager. ![oss]                  | 8689   | 2025-05-09  |
| [AltSnap](https://github.com/RamonUnch/AltSnap)      | Window snapping with keyboard shortcuts. ![oss]           | 3651   | 2025-05-17  |
