...
| [Testacles](https://github.com/manosbatsis/corda-testacles)      | Tools to grow CorDapp test suites.                                                                                               | 2     | 2021-08-21  |

## Tutorials

| Name                                                | Description                                                 | Stars | Last Commit |
|-----------------------------------------------------|-------------------------------------------------------------|-------|-------------|
| [Sample CorDapps](https://github.com/corda/samples) | Explore the code of sample CorDapps targeting various uses. | 98    | 2020-05-15  |

## CorDapps

| Name                                                                           | Description                                                 | Stars | Last Commit |
|--------------------------------------------------------------------------------|-------------------------------------------------------------|-------|-------------|
| [Private health insurance management](https://github.com/corda-codeclub/marge) | A private health insurance CorDapp.                         | 11    | 2022-12-08  |
| [Credit scoring](https://github.com/rafaelazeredo/creditbank)                  | A credit scoring service between the user and retail banks. | 7     | 2018-08-06  |
| [Auction](https://github.com/ashutoshmeher-r3/auction-cordapp)                 | A demo auction CorDapp.                                     | 1     | 2020-10-06  |
