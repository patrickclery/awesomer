...
- [Game Boy Printer Sniffer](https://github.com/mofosyne/GameboyPrinterSniffer) - Sniff packet communications between a Game Boy and the Printer. Methods to improve and/or manipulate the camera's quality and behavior:
...
- [Game Boy Assembly Programming for the Modern Game Developer](https://github.com/ahrnbom/gbapfomgd) - An e-book about making Game Boy games in Assembly. Fragments of code, effects, proof of concepts and generally non complete games.
...
- [llvm-gbz80](https://github.com/Bevinsky/llvm-gbz80)
