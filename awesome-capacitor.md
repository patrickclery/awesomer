...
- [`cordova-plugin-admobpro`](https://github.com/floatinghotpot/cordova-admob-pro)
- [`cordova-plugin-braintree`](https://github.com/Taracque/cordova-plugin-braintree)
- [`cordova-plugin-code-push`](https://github.com/microsoft/code-push)
...
- [`cordova-plugin-music-controls`](https://github.com/homerours/cordova-music-controls-plugin)
