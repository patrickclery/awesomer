...
- [SQLGlot](https://github.com/tobymao/sqlglot) - Pure Python SQL parser, transpiler, and builder. Run SQL queries against anything
...
- [sqls](https://github.com/lighttiger2505/sqls) - SQL Language Server written in Go. Learning and puzzles for SQL
...
- [pg_flame](https://github.com/mgartner/pg_flame) - A flamegraph generator for Postgres `EXPLAIN ANALYZE` output. Useful SQL-scripts for various purposes
