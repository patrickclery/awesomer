...
| [factory_bot](https://github.com/thoughtbot/factory_bot)           | A library for setting up Ruby objects as test data.                                                                                                                                                                               | 8393  |     | 2026-02-10  |
| [vcr](https://github.com/vcr/vcr)                                  | Record your test suite's HTTP interactions and replay them during future test runs for fast, deterministic, accurate tests.                                                                                                       | 6034  |     | 2026-01-21  |
| [WebMock](https://github.com/bblimke/webmock)                      | Library for stubbing and setting expectations on HTTP requests in Ruby.                                                                                                                                                           | 4045  |     | 2026-01-16  |
...
| [Parallel Tests](https://github.com/grosser/parallel_tests)        | Ruby: 2 CPUs = 2x Testing Speed for RSpec, Test::Unit and Cucumber                                                                                                                                                                | 3490  |     | 2026-02-05  |
| [timecop](https://github.com/travisjeffery/timecop)                | A gem providing "time travel", "time freezing", and "time acceleration" capabilities, making it simple to test time-dependent code. It provides a unified method to mock Time.now, Date.today, and DateTime.now in a single call. | 3411  |     | 2025-11-24  |
| [Spring](https://github.com/rails/spring)                          | Rails application preloader                                                                                                                                                                                                       | 2816  |     | 2026-02-03  |
| [Poltergeist](https://github.com/teampoltergeist/poltergeist)      | A PhantomJS driver for Capybara                                                                                                                                                                                                   | 2499  |     | 2019-09-27  |
| [mutant](https://github.com/mbj/mutant)                            | Mutation testing for Ruby. AI writes your code. AI writes your tests. But who tests the tests?                                                                                                                                    | 2072  |     | 2026-02-05  |
| [Ferrum](https://github.com/rubycdp/ferrum)                        | Headless Chrome Ruby API                                                                                                                                                                                                          | 1972  |     | 2026-02-11  |
| [DuckRails](https://github.com/iridakos/duckrails)                 | Development tool to mock API endpoints quickly and easily - NOT MAINTAINED                                                                                                                                                        | 1716  |     | 2025-12-11  |
| [ffaker](https://github.com/ffaker/ffaker)                         | Faker refactored.                                                                                                                                                                                                                 | 1566  |     | 2026-01-05  |
| [Watir](https://github.com/watir/watir)                            | Watir Powered By Selenium                                                                                                                                                                                                         | 1546  |     | 2024-05-31  |
| [Appraisal](https://github.com/thoughtbot/appraisal)               | A Ruby library for testing your library against different versions of dependencies.                                                                                                                                               | 1313  |     | 2025-09-08  |
...
| Name                                                      | Description                                                                | Stars | 30d | Last Commit |
|-----------------------------------------------------------|----------------------------------------------------------------------------|-------|-----|-------------|
| [twilio-ruby](https://github.com/twilio/twilio-ruby)      | A Ruby gem for communicating with the Twilio API and generating TwiML      | 1379  |     | 2026-02-05  |
| [tweetstream](https://github.com/tweetstream/tweetstream) | A simple EventMachine-based library for consuming Twitter's Streaming API. | 1109  |     | 2021-08-24  |
| [gitlab](https://github.com/NARKOZ/gitlab)                | Ruby wrapper and CLI for the GitLab REST API                               | 1076  |     | 2025-12-29  |
...
| Name                                                           | Description                                                                         | Stars | 30d | Last Commit |
|----------------------------------------------------------------|-------------------------------------------------------------------------------------|-------|-----|-------------|
| [Streamio FFMPEG](https://github.com/streamio/streamio-ffmpeg) | Simple yet powerful ruby ffmpeg wrapper for reading metadata and transcoding movies | 1678  |     | 2024-05-08  |
...
| Name                                          | Description                         | Stars | 30d | Last Commit |
|-----------------------------------------------|-------------------------------------|-------|-----|-------------|
| [Cells](https://github.com/trailblazer/cells) | View components for Ruby and Rails. | 3079  |     | 2024-12-02  |
...
| Name                                | Description                     | Stars | 30d | Last Commit |
|-------------------------------------|---------------------------------|-------|-----|-------------|
| [gon](https://github.com/gazay/gon) | Your Rails variables in your JS | 3087  |     | 2026-01-11  |
...
| Name                                                           | Description                                                                                                                                                                                                                                         | Stars | 30d | Last Commit |
|----------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|-----|-------------|
| [Mechanize](https://github.com/sparklemotion/mechanize)        | Mechanize is a ruby library that makes automated web interaction easy.                                                                                                                                                                              | 4442  |     | 2026-01-19  |
| [Upton](https://github.com/propublica/upton)                   | A batteries-included framework for easy web-scraping. Just add CSS! (Or do more.)                                                                                                                                                                   | 1601  |     | 2018-12-26  |
| [Wombat](https://github.com/felipecsl/wombat)                  | Lightweight Ruby web crawler/scraper with an elegant DSL which extracts structured data from pages.                                                                                                                                                 | 1355  |     | 2025-11-27  |
| [Kimurai](https://github.com/vifreefly/kimuraframework)        | Write web scrapers in Ruby using a clean, AI-assisted DSL. Kimurai uses AI to figure out where the data lives, then caches the selectors and scrapes with pure Ruby. Get the intelligence of an LLM without the per-request latency or token costs. | 1090  |     | 2026-01-27  |
| [MetaInspector](https://github.com/jaimeiniesta/metainspector) | Ruby gem for web scraping purposes. It scrapes a given URL, and returns you its title, meta description, meta keywords, links, images...                                                                                                            | 1047  |     | 2026-01-29  |
...
| Name                                                      | Description                                     | Stars | 30d | Last Commit |
|-----------------------------------------------------------|-------------------------------------------------|-------|-----|-------------|
| [Trailblazer](https://github.com/trailblazer/trailblazer) | The advanced business logic framework for Ruby. | 3478  |     | 2025-07-15  |
...
| Name                                         | Description                                                                | Stars | 30d | Last Commit |
|----------------------------------------------|----------------------------------------------------------------------------|-------|-----|-------------|
| [Puma](https://github.com/puma/puma)         | A Ruby/Rack web server built for parallelism                               | 7869  |     | 2026-02-09  |
| [Falcon](https://github.com/socketry/falcon) | A high-performance web server for Ruby, supporting HTTP/1, HTTP/2 and TLS. | 2933  |     | 2026-02-11  |
| [Thin](https://github.com/macournoyer/thin)  | A very fast & simple Ruby web server                                       | 2279  |     | 2025-06-24  |
...
| Name                                              | Description                                                 | Stars | 30d | Last Commit |
|---------------------------------------------------|-------------------------------------------------------------|-------|-----|-------------|
| [Slanger](https://github.com/stevegraham/slanger) | Open Pusher implementation compatible with Pusher libraries | 1691  |     | 2022-07-21  |
